...
## title: LPT Purpose description: The formal economic and protocol purpose of the Livepeer Token (LPT).
...
Its purpose is not speculative. Its purpose is structural.
...
LPT does not execute jobs. It economically secures the actors who do.
...
- B\_i = bonded stake of orchestrator i
- B\_T = total bonded stake
...
Poor operators lose stake. High-performing operators attract stake.
...
- V\_i = voting weight of participant i

Then:

V\_i = bonded LPT of participant i
