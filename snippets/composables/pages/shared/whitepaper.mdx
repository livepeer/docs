...
![Livepeer Network Example](https://s3.amazonaws.com/livepeerorg/LPExample.png)
...
| **Truebit** | Blackbox verification protocol that guarantees correctness of computation placed on chain (at a hefty cost) [[6](#references)]. () |
...
![Protocol Visual Overview](https://livepeer-dev.s3.amazonaws.com/docs/lpprotocol.png)  
...
1. Ethereum White Paper - Vitalik Buterin - Ethereum Wiki - 
2. Fat Protocols - Joel Monegro - USV Blog - 
3. Crypto Tokens and the Coming Age of Protocol Innovation - Albert Wenger - 
4. The Case For SectorCoins - Eric Tang - 
5. Delegated Proof-of-Stake Consensus - Daniel Larimer - 
6. Truebit - Jason Teutsch and Christian Reitweisner - 
7. swap, swear and swindle, incentive system for swarm - viktor trón, aron fischer, dániel a. nagy, zsolt felföldi, nick johnson - 
8. Kademlia: A Peer-to-peer Information System Based On The XOR Metric - Petar Maymounkov and David Mazieres 
9. Steem Whitepaper - Daniel Larimer, Ned Scott, Valentine Zavgorodnev, Benjamin Johnson, James Calfee, Michael Vandeberg - 
10. Introducing Casper "the Friendly Ghost" - Vlad Zamfir - 
11. Tendermint Docs - Jae Kwon and Ethan Buchman - 
12. Swarm - 
13. Incentives Build Robustness in BitTorrent - Bram Cohen - 
14. WebTorrent - 
15. Raiden Network - 
16. ERC20 Token Standard - 
17. Peer5 leverages viewers’ devices for a P2P approach to streaming video - 
18. Peer-to-Peer Streaming Peer Protocol - 
