...
- **New AI model support** - Added support for SD 1.5 and SDXL video-to-video pipelines, along with Scope pipeline support for orchestrator workers. These expand the range of [AI pipelines](/v2/developers/build/ai-and-agents/model-support) available on the network.
...
<CardGroup cols={2}>
  ...
  <Card title="AI on Livepeer" icon="microchip-ai" href="/v2/developers/build/ai-and-agents/model-support" arrow>
