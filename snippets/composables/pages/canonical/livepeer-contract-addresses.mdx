...
import {
  ...
  NonActiveAccordionGroup,
  HistoricalCategoriesAccordionGroup,
...
export const NonActiveAccordionGroup = ({ sourceData }) => (
  <AccordionGroup>
    {getNonActiveGroups(sourceData).map((group) => (
...
export const HistoricalCategoriesAccordionGroup = ({ sourceData }) => (
  <AccordionGroup>
    {getHistoricalCategories(sourceData).map((group) => {
...
<NonActiveAccordionGroup sourceData={contractAddresses} />
...
<HistoricalCategoriesAccordionGroup sourceData={contractAddresses} />
