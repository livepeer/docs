...
import {
  NonActiveContractsAccordion,
  HistoricalContractsAccordion,
} from '/snippets/components/integrators/feeds/CanonicalContractAccordions.jsx'
...
} from '/snippets/data/contract-addresses/canonicalContractsPageData.jsx'
...
<AccordionGroup>
  ...
  <InlineDivider margin="0" />
    Governance Contracts power protocol upgrades via [LIPs](https://github.com/livepeer/LIPs) and a democratic [Governance Model](/v2/about/protocol/governance-and-treasury), and fund the public good [Treasury](/v2/about/protocol/governance-and-treasury).
        - Governor
        - LivepeerGovernor
        - Treasury
        - BondingVotes
