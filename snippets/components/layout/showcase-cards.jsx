 ...
 * @param {string} [mediaSrc="/snippets/assets/domain/00_HOME/Hero_Images/hero_showcase.png"] - media Src prop.
 * @param {string} [logo=""] - logo prop.
 * @param {string} [title="Project title"] - title prop.
 * @param {string} [subtitle="Project subtitle"] - subtitle prop.
 * @param {string} [description="Short project summary."] - description prop.
 * @param {string} [href="#"] - href prop.
 * @param {Array} [categoryTags=["Other"]] - category Tags prop.
 * @param {Array} [productTags=["Livepeer"]] - product Tags prop.
 * @param {Array} [links=[]] - links prop.
 * @param {object} [style={}] - style prop.
 * @param {object} [cardProps] - card Props prop.
 * @example
 * <InteractiveCard />
 */
  ...
  return (
    <Card href={href} arrow={false} {...cardProps}>
      ...
      <div style={{ display: "grid", gap: "0.75rem" }}>
        ...
        <ScrollBox maxHeight={160} showHint={false}>
          <div style={{ display: "grid", gap: "0.75rem" }}>
        ...
        <div>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem" }}>
            {productTags.map((tag) => (
              <span key={tag} style={{ fontSize: "0.8rem", fontWeight: 600 }}>
                {tag}
              </span>
            ))}
          </div>
      ...
      : [
          {
            ...
            description:
              "Use this component to render a small set of showcase cards in a two-column layout.",
            categoryTags: ["Other"],
            productTags: ["Livepeer"],
          },
          {
            ...
            subtitle: "Template card",
            description:
              "Pass an items array to render real showcase content without inline page styling.",
            categoryTags: ["Video Streaming"],
            productTags: ["Frameworks"],
          },
        ];
  ...
  return (
    <Columns cols={2}>
      {showcaseItems.map((item, index) => (
        <InteractiveCard
          key={item.title || item.href || `interactive-card-${index}`}
          {...item}
        />
      ))}
    </Columns>
