 ...
 * @tier composite
 * @status stable
 * @description Card Carousel layout component for arranging documentation content without MDX inline styles.
 ...
 * @param {number} [visibleCount=3] - visible Count prop.
 * @param {string} [gap="1.5rem"] - gap prop.
 * @param {boolean} [showDots=true] - show Dots prop.
