 ...
 * @tier primitive
 * @status stable
 * @description Social Links primitive used in authored documentation and component-library examples.
 ...
 * @param {number} [size=20] - size prop.
 * @param {string} [gap="0.75rem"] - gap prop.
 * @param {string} [justify="center"] - justify prop.
