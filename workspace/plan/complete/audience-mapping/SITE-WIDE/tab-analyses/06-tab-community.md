...
- `portal.mdx` (6.9KB) — tab entry point
- `faq.mdx` (7.7KB) — ✅ general FAQ

### community/
- `guidelines.mdx` (19.7KB) — ✅ comprehensive
- `governance.mdx` (14KB) — ✅ covers Foundation and governance overview
...
### 4.1 `connect/` — needs population confirmed
...
### 4.2 `contribute/` — needs population confirmed
...
```
v2/community/
├── portal.mdx                ✅ entry point
├── index.mdx                           ✅ routing
├── faq.mdx                             ✅ good — audit for cross-tab duplication
│
├── community/
│   ├── guidelines.mdx        ✅ comprehensive
│   ├── governance.mdx   ✅ good — scope boundary with About needed
