...
**Quality bar:** `node operations/tests/unit/docs-guide-sot.test.js --check` returns 0 unknown-state pages. The `lpd-cli.mdx` freshness gate detects drift from `lpd --help` output.
