...
- the typed work lives in `.github/scripts/fetch-contract-addresses.js` and `operations/scripts/integrators/content/data/contracts/pipeline.js`
...
| Runtime module | `operations/scripts/integrators/content/data/contracts/pipeline.js` |
