...
| Resolution and generation | pipeline scripts | `operations/scripts/integrators/content/data/contracts/*` | one place recovers, verifies, and writes repo data |
...
flowchart TD
    ...
    F --> L[view-model.js]
    H --> L
    L --> Q[canonicalContractsPageData.jsx]
    L --> R[canonicalContractsPageData.json]
    Q --> M[canonical contracts reference page]
