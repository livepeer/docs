**Status**: ⛔ DEPRECATED — pre-framework draft, does not reflect locked taxonomy or Prompt A/B split. Build from spec: `v2/_workspace/references/content-pipeline/10-prompt-input-spec.md` at Step 16.
