...
| `operations/scripts/automations/ai/agents/cross-agent-packager.js` | registry doc | canonical | governance | agent-runtime | script file | generated pack workflows | keep | required | Packaging path for generated packs |
| `operations/scripts/automations/ai/agents/sync-codex-skills.js` | registry doc | canonical | governance | agent-runtime | script file | Codex local sync workflows | keep | required | Sync path for managed local Codex installs |
