...
- Generated: 2026-03-16T04:05:28.056Z
...
- Matched claim families: 23
- Verified claims: 5
- Conflicted claims: 11
- Time-sensitive claims: 7
- Unresolved claims: 18
- Contradiction groups: 11
- Propagation queue items: 61
- Evidence sources checked: 44
...
- `gw-startup-program-current` → `v2/gateways/guides/roadmap-and-funding/operator-support.mdx` [verify-only]
- ... 41 more item(s)
