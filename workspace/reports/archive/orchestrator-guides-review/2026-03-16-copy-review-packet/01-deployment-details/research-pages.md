...
- `orch-ai-routing-capability-based` (ai-routing-mechanics)
  ...
  - `v2/orchestrators/guides/deployment-details/dual-mode-configuration.mdx`: If your price exceeds what gateways will pay for a pipeline, you will not receive AI jobs for that pipeline regardless of hardware capability.
