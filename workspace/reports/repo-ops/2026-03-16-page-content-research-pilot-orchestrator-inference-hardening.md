...
| `v2/orchestrators/guides/ai-and-job-workloads/model-vram-reference.mdx` | guide | inferred-page | verify-only | `orch-ai-routing-capability-based` |
...
| `v2/orchestrators/guides/ai-and-job-workloads/video-transcoding.mdx` | guide | inferred-page | verify-only | `orch-ai-routing-capability-based` |
