...
- `v2/gateways/guides/payments-and-pricing/clearinghouse-guide.mdx`
  - claim families: `gw-clearinghouse-public-readiness`, `gw-community-signer-testing-surface`, `gw-offchain-payment-obligation`
...
- `v2/gateways/guides/payments-and-pricing/remote-signers.mdx`
  - claim families: `gw-community-signer-testing-surface`, `gw-offchain-payment-obligation`, `gw-remote-signer-current-scope`
...
- `v2/gateways/guides/roadmap-and-funding/operator-support.mdx`
  - claim families: `gw-clearinghouse-public-readiness`, `gw-community-signer-testing-surface`, `gw-discord-community-signal`, `gw-remote-signer-current-scope`, `gw-self-hosted-business-case`, `gw-spe-funded-provider-examples`, `gw-startup-program-current`
...
- `gw-discord-community-signal` (conflicted, low)
  ...
  - evidence why: source priority 90; 5 matched terms
...
- `gw-spe-funded-provider-examples` (conflicted, low)
  ...
  - evidence why: source priority 50; 5 matched terms; claim-family source preference 14; recency 206d; state open; current-language match 1
...
- `gw-discord-community-signal` (community-signal)
  ...
  - `v2/gateways/guides/payments-and-pricing/remote-signers.mdx`: Community, community
  - `v2/gateways/guides/payments-and-pricing/clearinghouse-guide.mdx`: Community, community
...
| `v2/gateways/guides/payments-and-pricing/clearinghouse-guide.mdx` | guide | inferred-page | verify-only | `gw-discord-community-signal` |
...
| `v2/gateways/guides/payments-and-pricing/remote-signers.mdx` | guide | inferred-page | verify-only | `gw-discord-community-signal` |
...
- `gw-spe-funded-provider-examples` → forum-topic: https://forum.livepeer.org/t/spe-milestone-report/3035
  ...
  - why selected: source priority 50; 5 matched terms; claim-family source preference 14; recency 206d; state open; current-language match 1
  - why not primary: highest ranked matched source
...
- `gw-startup-program-current` → forum-topic: https://forum.livepeer.org/t/2024-end-of-year-update-livepeer-cloud-spe/2678
  ...
  - why selected: source priority 50; 3 matched terms; claim-family source preference 14; recency 258d; state open; current-language match 3; historical-language penalty 1
  - why not primary: lower source priority than primary evidence
