...
- `v2/orchestrators/guides/operator-considerations/business-case.mdx`
  ...
  - extracted: The business case shifts from inflation first participation to fee driven service delivery.
  - extracted: It explains how fee driven operation differs from inflation first participation, what Gateways care about, and what changes when the goal is recurring service revenue instead of opportunistic earnings.
...
- `v2/orchestrators/guides/operator-considerations/operator-impact.mdx`
  - claim families: none
  - extracted: Bonded stake determines how much influence you carry over protocol rules, treasury direction, and the case for open compute infrastructure.
...
- `v2/orchestrators/guides/operator-considerations/operator-rationale.mdx`
  ...
  - extracted: Run a Livepeer Orchestrator when the earning path matches your hardware, stake access, and operating tolerance.
...
- `v2/orchestrators/guides/operator-considerations/requirements.mdx`
  - claim families: none
  - extracted: GPU Vendor Support NVIDIA is the supported vendor line for go livepeer.
...
- `orch-business-case-cost-viability` (time-sensitive, medium)
  ...
  - evidence why: source priority 90; 10 matched terms; current-language match 46; historical-language penalty 1
...
- `orch-business-case-cost-viability` → repo-file: v2/orchestrators/guides/operator-considerations/operator-rationale.mdx
  ...
  - why selected: source priority 90; 10 matched terms; current-language match 46; historical-language penalty 1
  - why not primary: highest ranked matched source
