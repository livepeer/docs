...
- the entrypoint is intentionally thin and delegates all typed work to `operations/scripts/automations/content/data/contracts/pipeline.js`
...
Current watch set from `operations/scripts/automations/content/data/contracts/constants.js`:
...
The current `runContractsPipeline()` order in `operations/scripts/automations/content/data/contracts/pipeline.js` is:
