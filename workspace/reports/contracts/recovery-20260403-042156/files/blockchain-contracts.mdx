...
export const explorerBase = {
  arbitrumOne:
    blockchainContractsPageData?.meta?.explorerUrls?.arbiscanAddress
    || `${blockchainContractsPageData?.meta?.explorerUrls?.arbiscan || 'https://arbiscan.io'}/address/`,
  ethereumMainnet:
    blockchainContractsPageData?.meta?.explorerUrls?.etherscanAddress
    || `${blockchainContractsPageData?.meta?.explorerUrls?.etherscan || 'https://etherscan.io'}/address/`,
}

export const contractByName = {
  arbitrumOne: {
...
export const getNamedContract = (chain, name) => contractByName?.[chain]?.[name] || null
...
<Tip>
  ...
  <span style={{color: "var(--text)", marginTop: "0.5rem"}}> Last Verified: <DataWrap value={blockchainContractsPageData.meta.lastVerified} /> </span>
</Tip>
...
<Accordion  title={<CustomCardTitle variant="accordion" icon={<ArbitrumIcon color="var(--arbitrum)" />} title="Controller"/>} >
  <AddressLinks
  address={controller}
  blockchainHref={explorerHref('arbitrumOne', 'Controller')}
  githubHref={codeHref('arbitrumOne', 'Controller')}
/>
...
<SolidityEmbed
  url={blockchainContractsPageData.contracts.controller.rawContractCodeHref}
...
<Accordion title={<CustomCardTitle variant="accordion" icon={<ArbitrumIcon color="var(--arbitrum)" />} title="BondingManager" />}>
  **Address (Arbitrum One)**:
  <AddressLinks address={bondingManagerProxy} blockchainHref={explorerHref('arbitrumOne', 'BondingManager', 'proxy')} githubHref={codeHref('arbitrumOne', 'BondingManager', 'proxy')} />
  {/* CHANGELOG PIPELINE UPDATE */}
...
<SolidityEmbed
  url={blockchainContractsPageData.contracts['bonding-manager'].rawContractCodeHref}
...
<Accordion title={<CustomCardTitle variant="accordion" icon={<ArbitrumIcon color="var(--arbitrum)" />} title="TicketBroker" />}>
  **Address (Arbitrum One)**:
  <AddressLinks address={ticketBrokerProxy} blockchainHref={explorerHref('arbitrumOne', 'TicketBroker', 'proxy')} githubHref={codeHref('arbitrumOne', 'TicketBroker', 'proxy')} />
  {/* CHANGELOG PIPELINE UPDATE */}
...
<SolidityEmbed
  url={blockchainContractsPageData.contracts['ticket-broker'].rawContractCodeHref}
...
<Accordion title={<CustomCardTitle variant="accordion" icon={<ArbitrumIcon color="var(--arbitrum)" />} title="RoundsManager" />}>
  **Address (Arbitrum One)**:
  <AddressLinks address={roundsManagerProxy} blockchainHref={explorerHref('arbitrumOne', 'RoundsManager', 'proxy')} githubHref={codeHref('arbitrumOne', 'RoundsManager', 'proxy')} />
  {/* CHANGELOG PIPELINE UPDATE */}
<Icon icon="check" color="var(--text)"/> _Verified · Controller registered · Active · Proxy target resolved_
...
<SolidityEmbed
  url={blockchainContractsPageData.contracts['rounds-manager'].rawContractCodeHref}
...
<Accordion title={<CustomCardTitle variant="accordion" icon={<ArbitrumIcon color="var(--arbitrum)" />} title="Minter" />}>
  **Address (Arbitrum One)**:
  <AddressLinks address={minter} blockchainHref={explorerHref('arbitrumOne', 'Minter')} githubHref={codeHref('arbitrumOne', 'Minter')} />
  {/* CHANGELOG PIPELINE UPDATE */}
...
<SolidityEmbed
  url={blockchainContractsPageData.contracts.minter.rawContractCodeHref}
...
<Accordion title={<CustomCardTitle variant="accordion" icon={<ArbitrumIcon color="var(--arbitrum)" />} title="ServiceRegistry" />}>
  **Address (Arbitrum One)**:
  <AddressLinks address={serviceRegistryProxy} blockchainHref={explorerHref('arbitrumOne', 'ServiceRegistry', 'proxy')} githubHref={codeHref('arbitrumOne', 'ServiceRegistry', 'proxy')} />
  {/* CHANGELOG PIPELINE UPDATE */}
<Icon icon="check" color="var(--text)"/> _Verified · Controller registered · Active · Proxy target resolved_
...
<SolidityEmbed
  url={blockchainContractsPageData.contracts['service-registry'].rawContractCodeHref}
...
<Accordion title={<CustomCardTitle variant="accordion" icon={<ArbitrumIcon color="var(--arbitrum)" />} title="AIServiceRegistry" />}>
  **Address (Arbitrum One)**:
  <AddressLinks address={aiServiceRegistry} blockchainHref={explorerHref('arbitrumOne', 'AIServiceRegistry')} githubHref={codeHref('arbitrumOne', 'AIServiceRegistry')} />
  {/* CHANGELOG PIPELINE UPDATE */}
...
<Accordion title={<CustomCardTitle variant="accordion" icon={<LivepeerIcon color="var(--accent)" size={13} />} title="LivepeerToken" />}>
  **Address (Arbitrum One)**:
  <AddressLinks address={lptArb} blockchainHref={explorerHref('arbitrumOne', 'LivepeerToken')} githubHref={codeHref('arbitrumOne', 'LivepeerToken')} />
  {/* CHANGELOG PIPELINE UPDATE */}
<Icon icon="check" color="var(--text)"/> _Verified · Controller registered · Active_

**Address (Ethereum Mainnet)**:

  <AddressLinks address={lptEth} blockchainHref={explorerHref('ethereumMainnet', 'LivepeerToken')} githubHref={codeHref('ethereumMainnet', 'LivepeerToken')} />
  {/* CHANGELOG PIPELINE UPDATE */}
<Icon icon="check" color="var(--text)"/> _Verified · Controller registered · Active_
...
<SolidityEmbed
  url={blockchainContractsPageData.contracts['livepeer-token-arbitrum'].rawContractCodeHref}
...
<Info>
  ...
  <span style={{display: "flex", alignItems: "center", marginTop: "0.5rem"}}> See <DoubleIconLink label="BridgeMinter.sol" href={codeHref('ethereumMainnet', 'BridgeMinter')}/> on the `streamflow` branch of `livepeer/protocol`</span>
</Info>

<Accordion title={<CustomCardTitle variant="accordion" icon={<Icon icon="ethereum" color="var(--hero-text)"/>} title="BridgeMinter" />}>
  **Address (Ethereum Mainnet)**:
  <AddressLinks address={bridgeMinter} blockchainHref={explorerHref('ethereumMainnet', 'BridgeMinter')} githubHref={codeHref('ethereumMainnet', 'BridgeMinter')} />
...
<SolidityEmbed
  url={blockchainContractsPageData.contracts['bridge-minter'].rawContractCodeHref}
...
<Accordion title={<CustomCardTitle variant="accordion" icon={<ArbitrumIcon color="var(--arbitrum)" />} title="Bridge Gateways" />}>
  **L2LPTGateway (Arbitrum One)**:
  <AddressLinks address={l2Gateway} blockchainHref={explorerHref('arbitrumOne', 'L2LPTGateway')} githubHref={codeHref('arbitrumOne', 'L2LPTGateway')} />
  {/* CHANGELOG PIPELINE UPDATE */}
  <Icon icon="check" color="var(--text)"/> _Verified · Bridge-derived · Bridge artifact confirmed · Active_

**L1LPTGateway (Ethereum Mainnet)**:

  <AddressLinks address={l1Gateway} blockchainHref={explorerHref('ethereumMainnet', 'L1LPTGateway')} githubHref={codeHref('ethereumMainnet', 'L1LPTGateway')} />
  {/* CHANGELOG PIPELINE UPDATE */}
  <Icon icon="check" color="var(--text)"/> _Verified · Bridge-derived · Bridge artifact confirmed · Active_

**L1Escrow (Ethereum Mainnet)**:

  <AddressLinks address={l1Escrow} blockchainHref={explorerHref('ethereumMainnet', 'L1Escrow')} githubHref={codeHref('ethereumMainnet', 'L1Escrow')} />
  {/* CHANGELOG PIPELINE UPDATE */}
  <Icon icon="check" color="var(--text)"/> _Verified · Bridge-derived · Bridge artifact confirmed · Active_
...
<SolidityEmbed
  url={blockchainContractsPageData.contracts['l2-lpt-gateway'].rawContractCodeHref}
...
<Accordion title={<CustomCardTitle variant="accordion" icon={<ArbitrumIcon color="var(--arbitrum)" />} title="BondingVotes" />}>
  **Address (Arbitrum One)**:
  <AddressLinks address={bondingVotesProxy} blockchainHref={explorerHref('arbitrumOne', 'BondingVotes', 'proxy')} githubHref={codeHref('arbitrumOne', 'BondingVotes', 'proxy')} />
  {/* CHANGELOG PIPELINE UPDATE */}
...
<SolidityEmbed
  url={blockchainContractsPageData.contracts['bonding-votes'].rawContractCodeHref}
...
<Accordion title={<CustomCardTitle variant="accordion" icon={<ArbitrumIcon color="var(--arbitrum)" />} title="Governor" />}>
  **Address (Arbitrum One)**:
  <AddressLinks address={governor} blockchainHref={explorerHref('arbitrumOne', 'Governor')} githubHref={codeHref('arbitrumOne', 'Governor')} />
  {/* CHANGELOG PIPELINE UPDATE */}
...
<SolidityEmbed
  url={blockchainContractsPageData.contracts.governor.rawContractCodeHref}
...
<Accordion title={<CustomCardTitle variant="accordion" icon={<ArbitrumIcon color="var(--arbitrum)" />} title="LivepeerGovernor" />}>
  **Address (Arbitrum One)**:
  <AddressLinks address={livepeerGovernorProxy} blockchainHref={explorerHref('arbitrumOne', 'LivepeerGovernor', 'proxy')} githubHref={codeHref('arbitrumOne', 'LivepeerGovernor', 'proxy')} />
  {/* CHANGELOG PIPELINE UPDATE */}
<Icon icon="check" color="var(--text)"/> _Verified · Controller registered · Active · Proxy target resolved_
...
<SolidityEmbed
  url={blockchainContractsPageData.contracts['livepeer-governor'].rawContractCodeHref}
...
<Accordion title={<CustomCardTitle variant="accordion" icon={<ArbitrumIcon color="var(--arbitrum)" />} title="Treasury" />}>
  **Address (Arbitrum One)**:
  <AddressLinks address={treasury} blockchainHref={explorerHref('arbitrumOne', 'Treasury')} githubHref={codeHref('arbitrumOne', 'Treasury')} />
  {/* CHANGELOG PIPELINE UPDATE */}
<Icon icon="check" color="var(--text)"/> _Verified · Controller registered · Active_
...
<SolidityEmbed
  url={blockchainContractsPageData.contracts.treasury.rawContractCodeHref}
...
<Accordion title={<CustomCardTitle variant="accordion" icon={<ArbitrumIcon color="var(--arbitrum)" />} title="L2Migrator" />}>
  **Address (Arbitrum One)**:
  <AddressLinks address={l2Migrator} blockchainHref={explorerHref('arbitrumOne', 'L2Migrator', 'proxy')} githubHref={codeHref('arbitrumOne', 'L2Migrator', 'proxy')} />
...
<Accordion title={<CustomCardTitle variant="accordion" icon={<ArbitrumIcon color="var(--arbitrum)" />} title="MerkleSnapshot" />}>
  **Address (Arbitrum One)**:
  <AddressLinks address={merkleSnapshot} blockchainHref={explorerHref('arbitrumOne', 'MerkleSnapshot')} githubHref={codeHref('arbitrumOne', 'MerkleSnapshot')} />
...
<SolidityEmbed
  url={blockchainContractsPageData.contracts['merkle-snapshot'].rawContractCodeHref}
