...
const PAGE_URL = `${BASE_URL}/v2/about/livepeer-protocol/blockchain-contracts`;
...
async function main() {
  ...
  try {
    ...
    const unexpectedErrors = filterNoise(errors).filter((message) => !baselineErrors.has(message));
