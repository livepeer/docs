...
import {
  ...
  explorerHref,
  rawCodeHref,
} from '/snippets/composables/pages/canonical/data/blockchain-contracts-data.jsx'
...
<Tip>
  ...
  <span style={{color: "var(--text)", marginTop: "0.5rem"}}> Last Verified: <DataWrap value={lastVerifiedDate} /> </span>
</Tip>
...
<Icon icon="check" color="var(--text)"/> <span style={{fontStyle: "italic", color: "var(--text)"}}>Last Verified {<DataWrap value={lastVerifiedDate} />}</span>
