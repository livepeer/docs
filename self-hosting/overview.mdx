...
- Allows for development of applications against the Livepeer Studio API locally
  ...
  production.
- Bundles the Livepeer Network node
  [`Go-Livepeer`](https://github.com/livepeer/go-livepeer), so that you may test
  transcoding offchain or onchain with no external dependencies.
