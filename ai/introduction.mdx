...
- **Only Higher VRAM GPUs Supported**: At present, the AI Subnet necessitates
  GPUs with a minimum of 16GB VRAM for effective AI inference tasks. Efforts are
  underway to extend this support to GPUs with lower VRAM in the future.
