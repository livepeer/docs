...
<CardGroup cols={3}>
  <Card
    href="/ai/orchestrator/get-started"
...
[ai-runner Docker container](https://github.com/livepeer/ai-worker/tree/main/runner)
to execute AI models, simplifying the deployment and scalability of new
pipelines and models. Future enhancements will focus on improving the speed and
expanding the capabilities of this container to support more complex AI models
and custom user-defined pipelines.
