...
The Livepeer AI Network's `upscale` pipeline provides **advanced image upscaling**.
...
<Tip>
  ...
  the API, see the [Livepeer AI Network API Reference](/ai/api-reference/upscale).
</Tip>
...
[Livepeer AI Network API Reference](/ai/api-reference/upscale).
...
>
  Explore the `upscale` endpoint and experiment with the API in the Livepeer AI Network
  API Reference.
</Card>
