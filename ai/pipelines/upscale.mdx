...
```mermaid
graph LR
    A[<div style="width: 128px;"><img src="https://github.com/livepeer/ai-worker/assets/17570430/482d2005-65ae-4427-a1bd-96752372f152" alt="Image of low resolution cat"/></div>] --> B[Gateway]
