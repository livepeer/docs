...
The `speech-to-text` pipeline transcribes audio from media files to text. This pipeline powered is by the latest diffusion models at HuggingFace 
...
<Note>
Supported file types: `wav`, `flac`, `mp3`, `m4a` and `webm`
</Note>
