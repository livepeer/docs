...
The `image-to-video` pipeline of Livepeer AI allows you to generate animated
...
>
  Explore the `image-to-video` endpoint and experiment with the API in Livepeer AI
  API Reference.
</Card>
