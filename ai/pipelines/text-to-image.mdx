...
The pricing for the `text-to-image` pipeline is based on competitor pricing. However, 
...
is `1.9073484e-08 USD` per **output pixel**(`height * width * images`).
=======
set their maximum price for a job. The currently recommended pricing for this pipeline 
is `1.9073484e-08 USD` per **output pixel** (`height * width * images`).
>>>>>>> 3b090a90a9cf9a69d2ec2bba09867bec36fba95e
=======
set their maximum price for a job. The currently recommended pricing for this pipeline 
is `1.9073484e-08 USD` per **output pixel** (`height * width * images`).
>>>>>>> 48357c9 (refactor: add missing space)
