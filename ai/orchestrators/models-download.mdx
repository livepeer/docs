...
downloading the currently **recommended** models for Livepeer AI.
...
<Steps>
    ...
    <Step title="Download AI Models">
        ...
        This command downloads the recommended models for Livepeer AI and stores them in your machine's `~/.lpData/models` directory. To obtain a complete set of Livepeer AI models, omit the `--alpha` flag. This requires additional disk space.
    </Step>
