    ...
    <Tab title="Use Docker (Recommended)">
        <Steps>
            ...
            <Step title="Check Port Availability">
                To make your AI Subnet Orchestrator node accessible from the internet, you need to configure your network settings. Ensure that port `8936` is unblocked on your machine. Additionally, consider setting up port forwarding on your router, which will allow the Gateway node to be reachable from the internet.
            </Step>
        </Steps>
    </Tab>
