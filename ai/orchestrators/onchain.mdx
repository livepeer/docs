...
As the Livepeer AI Network is in its Alpha phase,
...
To make your AI Orchestrator node discoverable by AI Gateway nodes on the Livepeer AI
Network, you need to advertise your **AI service URI** on-chain. You can do this
...
<Tabs>
  <Tab title="Use Foundry Cast">
    ...
    Congratulations! Your **AI Orchestrator** node is now discoverable by **AI Gateway** nodes and is ready to execute AI inference tasks on the Livepeer AI Network! 🚀
  ...
  <Tab title="Use Livepeer CLI">
    <Note>Currently, setting your AI service URI using the Livepeer CLI is not supported during the **Alpha** phase of the Livepeer AI Network. This feature is planned for inclusion in future releases.</Note>
  </Tab>
</Tabs>
...
Orchestrator** node to start processing AI inference jobs on the Livepeer AI Network. The
...
- `-ethAcctAddr <Livepeer_AI_Network_ORCH_ETH_ADDRESS>`: Sets the Ethereum address of the
  AI Orchestrator.
...
Due to current limitations in the Livepeer AI Network software, two additional flags are
required:
