...
As Livepeer AI is in its Beta phase,
...
<Tabs>
  ...
  <Tab title="Use Livepeer CLI">
    <Note>Currently, setting your AI service URI using the Livepeer CLI is not supported during the **Beta** phase of the Livepeer AI Network. This feature is planned for inclusion in future releases.</Note>
  </Tab>
</Tabs>
...
Due to current limitations in the Livepeer AI software, two additional flags are
required:
