...
2. Validate lock before commit/push:
   - `node operations/scripts/validators/ai/codex/validate-locks.js --branch codex/<id>-<slug> --staged`
3. Finalize checks before PR:
   - `node operations/scripts/dispatch/ai/codex/task-finalise.js --branch codex/<id>-<slug>`
