...
1. Create branch + contract + lock:
   - `node tools/scripts/dispatch/ai/codex/task-preflight.js --task <id> --slug <slug> --scope <a,b,c>`
...
2. Validate lock before commit/push:
   - `node tools/scripts/dispatch/ai/codex/validate-locks.js --branch codex/<id>-<slug> --staged`
...
5. Release lock only after `docs-v2-dev` contains the task commit:
   - `node tools/scripts/dispatch/ai/codex/lock-release.js --branch codex/<id>-<slug>`
6. Cleanup merged local worktrees and stale local codex branches only after `docs-v2-dev` contains the task commit:
   - `node tools/scripts/dispatch/ai/codex/task-cleanup.js --branch codex/<id>-<slug> --apply`
