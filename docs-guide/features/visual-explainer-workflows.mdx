...
description: >-
  Maintainer-focused pilot guide for nicobailon/visual-explainer – an external
  Claude Code skill used for diff review, plan review, architecture diagrams,
  fact-check, and project recap. Optional; not a contributor gate, not CI.
audience: developer
pageType: guide
purpose: orient
status: current
