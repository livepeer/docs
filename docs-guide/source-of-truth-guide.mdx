...
| Features | Major repo systems, automation surfaces, functional maps, and implementation-ready gap analysis | [feature-map.mdx](./features/feature-map.mdx), [ai-features.mdx](./features/ai-features.mdx), [architecture-map.mdx](./features/architecture-map.mdx), [automations.mdx](./features/automations.mdx), [data-integrations.mdx](./features/data-integrations.mdx), [adaptive-architecture.mdx](./features/adaptive-architecture.mdx), [ui-system.mdx](./features/ui-system.mdx), [contributor-tools.mdx](./features/contributor-tools.mdx), [gap-analysis.mdx](./features/gap-analysis.mdx), [visual-explainer-workflows.mdx](./features/visual-explainer-workflows.mdx) |
