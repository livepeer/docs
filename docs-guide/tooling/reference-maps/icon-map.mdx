...
To check compliance: `node tools/scripts/audits/content/reference/audit-icon-usage.js --md --verbose`
</Tip>
...
```bash
node tools/scripts/audits/content/reference/audit-icon-usage.js --md --verbose
```
