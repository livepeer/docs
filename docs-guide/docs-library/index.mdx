...
| [Contracts](pipelines/contracts) | 39 on-chain contracts | P5 (scheduled) + manual | Daily 05:00 UTC + on-demand | Address resolution, on-chain verify, code provenance, anomaly reports |
