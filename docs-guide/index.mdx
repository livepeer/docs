...
The full governance map is auto-generated at [repo-governance-map](/docs-guide/repo-ops/config/repo-governance-map). Run `node operations/scripts/generators/governance/map/generate-governance-map.js --check` to verify all folders are governed and no frameworks are stale.
