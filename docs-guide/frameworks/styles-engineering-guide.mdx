...
<Note>
Internal engineering reference. For the user-facing style guide, see the [Documentation Style Guide](/v2/resources/documentation-guide/copy-style/style-guide).
</Note>
