...
|---|---|---|---|
| 1. Action | Thin workflow YAML files in `.github/workflows/`. Fires on event, calls a meta dispatcher (or pipeline directly). | **6** dispatch-{concern} actions + **5** interface-governance workflows = **11 active** | Triggered by GitHub events only – not runnable locally. |
