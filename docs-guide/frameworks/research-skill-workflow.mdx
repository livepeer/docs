...
- registry validation: `operations/scripts/docs-fact-registry.js`
- manual fact runner: `operations/scripts/docs-page-research.js`
- PR advisory runner: `operations/scripts/docs-page-research-pr-report.js`
- packet runner: `operations/scripts/docs-research-packet.js`
- adjudication workflow: `operations/scripts/docs-research-adjudication.js`
- research-to-plan template: `docs-guide/tooling/research-to-implementation-plan-template.md`
- local/manual PR prep integration: `operations/scripts/create-codex-pr.js --advisory-research`
...
```bash icon="terminal"
node operations/scripts/docs-research-packet.js \
...
```bash icon="terminal"
node operations/scripts/create-codex-pr.js \
  --advisory-research \
...
```bash icon="terminal"
node operations/scripts/docs-research-adjudication.js \
  --validate \
