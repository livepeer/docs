...
description: "Operational map of layered quality gates from pre-commit hooks through CI sweeps with ownership and blocking defaults."
keywords:
  - livepeer
  - quality gates
  - hooks
...
- staged selection should respect governed non-publishable V2 lanes once they are encoded in `.mintignore` and shared file-selection helpers
