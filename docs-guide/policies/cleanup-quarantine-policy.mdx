...
```bash
node tools/scripts/remediators/content/repair/quarantine-manager.js --output-dir tasks/reports/repo-ops
```

Apply quarantine moves:

```bash
node tools/scripts/remediators/content/repair/quarantine-manager.js --output-dir tasks/reports/repo-ops --apply
```
