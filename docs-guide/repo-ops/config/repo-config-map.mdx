...
For secrets required by the solutions social data pipeline specifically, see [Solutions Secrets](/docs-guide/repo-ops/secrets/solutions-secrets).
...
- [Solutions Secrets](/docs-guide/repo-ops/secrets/solutions-secrets) — GitHub Actions secrets required by the social data pipeline
- [Enforcement Map](/docs-guide/repo-ops/maps/enforcement-map) — pre-commit gates, CI gates, and validators
