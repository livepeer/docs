...
For secrets required by the solutions social data pipeline specifically, see [Solutions Secrets](../secrets/solutions-secrets).
...
- [Solutions Secrets](../secrets/solutions-secrets) — GitHub Actions secrets required by the social data pipeline
- [Enforcement Map](../maps/enforcement-map) — pre-commit gates, CI gates, and validators
