...
Required secrets: see [Solutions Secrets](/docs-guide/repo-ops/secrets/solutions-secrets).
...
- [Repo Config Map](/docs-guide/repo-ops/config/repo-config-map) — configuration files read by hooks and workflows
- [Solutions Secrets](/docs-guide/repo-ops/secrets/solutions-secrets) — GitHub Actions secrets for the social data pipeline
