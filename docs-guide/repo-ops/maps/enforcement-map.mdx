...
Required secrets: see [Solutions Secrets](../secrets/solutions-secrets).
...
- [Repo Config Map](../config/repo-config-map) — configuration files read by hooks and workflows
- [Solutions Secrets](../secrets/solutions-secrets) — GitHub Actions secrets for the social data pipeline
