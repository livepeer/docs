...
Purpose: UI template catalog and snippet inventory derived from canonical template sources.
...
**Purpose**: UI template catalog and snippet inventory derived from canonical template sources. <br/>
