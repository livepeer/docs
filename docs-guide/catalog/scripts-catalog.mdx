...
{/*
TREE PER ROOT FOLDER (github actions, scripts, tools? ai-tools? )
*/}
...
{/*
GAH - UNREADABLE
- PER PIPELINE DIAGRAMS
-  READABLE PIPELINE DIAGRAM USE SCROLLABLEDIAGRAM
*/}
...
# Scripts
{/* SEARCHABLE TABLE HERE - ALL SCRIPTS */}

{/*  */}

# Scripts by Type & Concern
