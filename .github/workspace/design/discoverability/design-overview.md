# Discoverability: Design Overview

> Canonical doc for this concern. Updated as we progress. Single source of truth.

**Concern:** Discoverability
**Definition:** SEO, AEO, AI indexing, translation. Search engines, AI crawlers, and LLMs can find and understand content.
...
_What documents in the repo define discoverability requirements? What policies exist? What standards are written down?_
...
_What rules must be enforced for discoverability? Organised by category. Derived from research._
