# Copy: Design Overview

> Canonical doc for this concern. Updated as we progress. Single source of truth.

**Concern:** Copy
**Definition:** Written content on pages is correct, current, and sourced from data pipelines. The actual text users read.
...
_What documents in the repo define copy requirements? What policies exist? What standards are written down?_
...
_What rules must be enforced for copy? Organised by category. Derived from research._
