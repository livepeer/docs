...
**Concern:** Brand
**Definition:** Style, formatting, page structure, voice. Content is consistent across all pages.
...
_What documents in the repo define brand requirements? What policies exist? What standards are written down?_
...
_What rules must be enforced for brand? Organised by category. Derived from research._
