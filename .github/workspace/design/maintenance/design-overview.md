# Maintenance: Design Overview

> Canonical doc for this concern. Updated as we progress. Single source of truth.

**Concern:** Maintenance
**Definition:** Indexes, catalogs, registries, reference data, scaffolding. Supporting infrastructure that keeps the site navigable and contributor-friendly.
...
_What documents in the repo define maintenance requirements? What policies exist? What standards are written down?_
...
_What rules must be enforced for maintenance? Organised by category. Derived from research._
