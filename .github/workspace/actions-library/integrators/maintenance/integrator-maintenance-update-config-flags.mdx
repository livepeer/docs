...
keywords:
  ...
  - integrator
  - maintenance
  - integrator-maintenance-update-config-flags
---
...
| Field | Value |
|---|---|
| **Current file** | `.github/workflows/integrator-maintenance-update-config-flags.yml` |
| **New name** | `integrator-maintenance-update-config-flags.yml` |
| **Type** | `integrator` |
| **Concern** | `maintenance` |
...
```mermaid
graph LR
    TRIGGER["schedule, workflow_dispatch"] --> WF["integrator-maintenance-update-config-flags"]
    WF --> OUTPUT["output"]
```
