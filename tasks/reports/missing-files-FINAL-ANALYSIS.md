# Missing Files FINAL Analysis: MOVED vs DELETED

**Date:** Wed Feb 18 00:04:31 AEDT 2026
**Current Branch:** docs-v2-test

## Executive Summary

- **Total files in origin/docs-v2-tests:** 1416
- **Total files in current branch:** 1516
- **Files missing from current:** 223

## Analysis Results

### ✅ MOVED FILES (220 files)

All files from `origin/docs-v2-tests` that exist in the current branch with different paths:
...
Out of 223 files from `origin/docs-v2-tests`:
- ✅ **220 files were MOVED** to new locations per migration plan
- ❌ **0 files were DELETED** (not found anywhere in current branch)

---
**Report Generated:** Wed Feb 18 00:04:36 AEDT 2026
