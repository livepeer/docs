...
- `v2/orchestrators/guides/config-and-optimisation/pricing-strategy.mdx`
  ...
  - extracted: Use the current Livepeer Explorer and your own routed volume as the reference point rather than treating any single historical range as fixed.
...
- `v2/orchestrators/guides/config-and-optimisation/reward-call-tuning.mdx`
  ...
  - extracted: For orchestrators with small stake, the gas cost of the call can exceed the LPT value received — at which point calling reward destroys value rather than creating it.
  - extracted: This page covers: the profitability calculation, the flag for enabling or disabling automatic calling, manual calling via , timing considerations, and when to skip rounds intentionally.
