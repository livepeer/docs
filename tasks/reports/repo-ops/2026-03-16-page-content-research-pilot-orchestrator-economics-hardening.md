...
- `v2/orchestrators/guides/staking-and-rewards/rewards-and-fees.mdx`
...
- `v2/orchestrators/guides/staking-and-rewards/rewards-and-fees.mdx`
  - claim families: `orch-dual-revenue-model`, `orch-reward-profitability-threshold`
...
- `orch-batch-ai-vram-threshold` → repo-file: v2/orchestrators/guides/deployment-details/requirements.mdx
  ...
  - why selected: source priority 90; 12 matched terms; current-language match 12
...
- `orch-pool-vs-solo-prerequisites` → repo-file: v2/orchestrators/guides/deployment-details/setup-options.mdx
  ...
  - result: repo evidence matched
  - rank: 90; score: 150
  - matched terms: No LPT, just a GPU, Pool worker, not an Orchestrator at all, no lpt required, staking, setup options
  - why selected: source priority 90; 6 matched terms
- `orch-bandwidth-per-stream-planning` → repo-file: v2/orchestrators/guides/deployment-details/requirements.mdx
  ...
  - why selected: source priority 90; 8 matched terms; current-language match 12
...
- `orch-business-case-cost-viability` → repo-file: v2/orchestrators/guides/operator-considerations/operator-rationale.mdx
  ...
  - why selected: source priority 90; 9 matched terms; current-language match 39; historical-language penalty 3
- `orch-business-case-cost-viability` → repo-file: v2/orchestrators/guides/deployment-details/requirements.mdx
  - checked: 2026-03-16
  - result: repo evidence matched
  - rank: 90; score: 138
  - matched terms: 1 Gbps symmetric, 100 Mbps symmetric, 24 GB, operator rationale
  - why selected: source priority 90; 4 matched terms; current-language match 12
- `orch-consumer-nvenc-session-cap` → repo-file: v2/orchestrators/guides/deployment-details/requirements.mdx
  ...
  - why selected: source priority 90; 10 matched terms; current-language match 12
...
- `orch-siphon-reward-isolation` → github-repo: https://github.com/Stronk-Tech/OrchestratorSiphon
  ...
  - why selected: source priority 60; 2 matched terms
...
- `orch-commercial-model-warmth` → repo-file: v2/orchestrators/guides/deployment-details/dual-workload-setup.mdx
  ...
  - result: repo evidence matched
  - rank: 90; score: 160
  - matched terms: "warm": true, model stays warm in VRAM, warm in VRAM, cold starts are SLA failures, keep them warm, pre-loaded and warm, warm at startup
...
- `orch-siphon-github-current` → github-repo: https://github.com/Stronk-Tech/OrchestratorSiphon
  ...
  - why selected: source priority 60; 4 matched terms
