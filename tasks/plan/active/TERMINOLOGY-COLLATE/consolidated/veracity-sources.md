---
title: Livepeer Documentation Source Registry
version: draft-1
generated: 2026-03-20
purpose: Lookup table for the review pipeline — maps sources to veracity tiers and information types
---

# Livepeer Documentation — Source Registry

> Generated from terminology collation research across all 9 doc tabs. Used by the review pipeline (Step 18) to verify claims per section.

---

## How to Use This Registry

Each entry maps a source to its veracity tier, information types, and staleness risk. The review pipeline (Step 18) consults this registry to determine what to check a claim against, and how strictly.

- **Veracity tier**: `primary` = must be consulted; `acceptable` = may support; `not-permitted` = never cite
- **Staleness risk**: how quickly a source goes out of date relative to the Livepeer release cycle
- **Update frequency**: `static` = rarely changes; `versioned` = changes with releases; `live` = changes continuously; `irregular` = no predictable cadence
