...
<Note>
  For real-time audio workloads (live ASR, live translation, streaming transcription), see [Workload Fit → ASR pipeline examples](../workload-fit#asr-pipeline-examples). These use Whisper or similar and are excellent fits.
</Note>
...
This matrix is intentionally conservative. If your model doesn't appear here, apply the [Workload Fit](../workload-fit) decision tree to evaluate it.
...
<CardGroup cols={2}>
  <Card title="Workload Fit" icon="circle-question" href="../workload-fit">
