...
For a full compatibility matrix by model family, see [Model Support](/v2/developers/ai-inference-on-livepeer/ai-pipelines/model-support).
...
<CardGroup cols={2}>
  <Card title="BYOC" icon="box" href="/v2/developers/ai-inference-on-livepeer/ai-pipelines/byoc">
    Developer guide to building BYOC containers — how to structure your inference server.
  </Card>
  <Card title="Model Support" icon="microchip-ai" href="/v2/developers/ai-inference-on-livepeer/ai-pipelines/model-support">
    Full model family compatibility matrix — which models work on Livepeer and why.
  </Card>
  <Card title="ComfyStream" icon="diagram-project" href="/v2/developers/ai-inference-on-livepeer/ai-pipelines/comfystream">
