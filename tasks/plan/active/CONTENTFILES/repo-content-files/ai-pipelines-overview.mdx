...
|---|---|---|---|
| Livepeer Studio | `https://livepeer.studio/api/beta/generate/` | Studio API key | Production apps |
| Cloud SPE | `https://dream-gateway.livepeer.cloud` | None (dev/free) | Development and experimentation |
| Self-hosted | Your gateway URL | Bearer token | Custom routing, private models |
...
<CardGroup cols={2}>
  <Card title="AI Inference Quickstart" icon="bolt-lightning" href="/v2/developers/building-on-livepeer/quick-starts/livepeer-ai" arrow>
