...
Workaround: Check the playback information of the asset and make sure that the playback policy is set to `null` or `public`   `https://livepeer.studio/api/playback/Playback_Id`
