...
description: "Set up multistreaming to push your Livepeer stream to multiple RTMP targets like Twitch, YouTube, and Facebook."
---
...
key should be provided by the platform that you're streaming into and can be one
