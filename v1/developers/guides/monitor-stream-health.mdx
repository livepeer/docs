...
description: "Monitor active stream health, transcoding status, multistream targets, and ingest rate via the API and dashboard."
---
...
<Tabs>
  ...
  <Tab title="Python">
    ...
    # Replace <value> with the stream ID you want to retrieve
