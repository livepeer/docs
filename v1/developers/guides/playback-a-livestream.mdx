...
description: "Play back livestreams using Livepeer UI Kit Player, third-party HLS players, or the embeddable iframe player."
---
...
The example below shows how to use the UI Kit [`Player`](/sdks/react/player/Root) to
play a livestream.
