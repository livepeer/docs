---
title: Overview
description: "Overview of all generative AI pipelines available on the Livepeer network, including supported models and usage examples."
---
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="video"
    href="/ai/pipelines/segment-anything-2"
  >
