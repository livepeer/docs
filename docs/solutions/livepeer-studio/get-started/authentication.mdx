...
By default, API keys can only be used from a backend server. This is to ensure maximum security and prevent you from accidentally exposing your account by including the secret API key in a public web page.
