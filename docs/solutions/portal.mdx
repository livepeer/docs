 ...
 {/* HeroImageBackgroundComponent: Full-width Starfield Background - fills entire content area */}
  ...
  <HeroContentContainer>
    ...
    <PortalHeroContent
      ...
      overview={
        <>
        Using real-time AI video apps is easy with these ecosystem products and developer platforms.
...
<PortalContentContainer>
 ...
 It provides identity, distribution, monetisation and sovereignty primitives to bring high-quality video experiences while preserving content authenticity.
    </Card>
 {/* <Card
      title="Embody"
      icon="book"
