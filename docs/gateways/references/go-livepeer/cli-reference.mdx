...
- transcoder: Set to true to be a transcoder. Default `false`

- gateway: Set to true to be a gateway (formerly known as _Broadcaster_).
 Default `false`
...
- recordstore: URL of object store for recordings. No default
