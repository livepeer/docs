...
reward: Set to true to run a reward service. If you do not want to automatically call `reward()`, you need to explicitly set this to `false`. Otherwise, it will default to true for on-chain orchestrators.
