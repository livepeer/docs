...
**Patch the NVIDIA driver** so that you will have an Encoder and Decoder on your NVIDA Graphics card. This will enable you to transcode unlimited concurrent streams at once.
**

- Go to [NVIDIA Developers] (https://developer.nvidia.com/video-encode-and-decode-gpu-support-matrix-new)

- Click on the drop down and see all the cards that are supported.
