...
<CardGroup cols={2}>
 ...
 Livepeer Studio is a developer-friendly gateway and toolkit for the Livepeer decentralised video infrastructure.
 ...
 The MistServer team is on a mission to democratise video infrastructure by leveraging decentralised protocols and open source technology -> creating a streaming infrastructure that doesn't lock you in.
