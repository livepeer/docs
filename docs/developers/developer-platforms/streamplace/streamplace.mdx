...
Streamplace is a **Special Purpose Entity (SPE)** in the Livepeer ecosystem responsible for building a **public-goods, open-source decentralised video layer** for social networks, livestreaming platforms, and Web3-native apps.
