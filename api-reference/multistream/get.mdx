...
await livepeer.multistreamTarget.get(id);
```
...
func main() {
	...
	res, err := client.MultistreamTarget.Get(ctx, id)
...
res = client.multistream_target.get(id=id)
...
res = client.multistream_target.get(req)
