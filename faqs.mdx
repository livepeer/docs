...
description: 'Information related to Livepeer such as pricing and using Studio'
---

<Accordion title="What is the pricing for Livepeer Studio?">
...
<Accordion title="Is there a list of example applications that use Livepeer?">
...
<Accordion title="Why did my stream get banned?">
...
<Accordion title="Does Livepeer have a grant program?">
...
<Accordion title="How do I change my password for the Livepeer gateway?">
...
<Accordion title="How do I request a feature for my project?">
...
<Accordion title="How do I see the status of the Livepeer Studio gateway?">

You can visit the status page here: https://livepeer.statuspage.io.
</Accordion>


<Accordion title="Can I create an API key without using Livepeer Studio?">
...
<Accordion title="Can I change my existing email to a differnt one in my Livepeer Studio account?">
