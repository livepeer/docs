...
<CardGroup cols={2}>
  ...
  <Card title="OBS Setup Guide" icon="video" href="/v2/platforms/products/livepeer-studio/guides/stream-via-obs" arrow>
    Configure OBS to stream to Livepeer.
  </Card>
  <Card title="Livepeer Player" icon="circle-play" href="/v2/platforms/products/livepeer-studio/guides/player-and-embed" arrow>
