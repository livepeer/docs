...
<CardGroup cols={2}>
  <Card title="Daydream Product Overview" href="/v2/platforms/products/daydream/daydream" icon="wand-magic-sparkles" arrow>
  ...
  <Card title="AI Pipelines Overview" href="/v2/developers/ai-inference-on-livepeer/ai-pipelines/overview" icon="robot" arrow>
