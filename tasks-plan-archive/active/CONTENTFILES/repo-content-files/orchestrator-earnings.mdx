...
- A percentage goes to the [Livepeer Treasury](https://explorer.livepeer.org/treasury) (currently 10% of each round's issuance)
...
<CardGroup cols={2}>
  ...
  <Card title="Setting Up an Orchestrator" icon="server" href="/v2/pages/05_orchestrators/setting-up-an-orchestrator" arrow>
