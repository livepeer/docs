...
<Tabs>
  <Tab title="I want to add video to my app">
    ...
    **Start here:**
    ...
    <CardGroup cols={2}>
      <Card title="Video Streaming Quickstart" icon="tower-broadcast" href="./quick-starts/video-streaming" arrow>
        Create a livestream, get a stream key, and play back with the Livepeer Player in minutes.
      </Card>
      <Card title="Livepeer Studio" icon="video-arrow-up-right" href="/v2/platforms/products/livepeer-studio/overview/overview" arrow>
  ...
  <Tab title="I want to run AI on video">
    ...
    **Start here:**
    ...
    <CardGroup cols={2}>
      <Card title="AI Inference Quickstart" icon="robot" href="./quick-starts/livepeer-ai" arrow>
        Run text-to-image and other AI pipelines in minutes using the Livepeer AI SDK.
      </Card>
      <Card title="AI Pipelines Overview" icon="circuit-board" href="/v2/developers/ai-inference-on-livepeer/ai-pipelines/overview" arrow>
        Understand how Livepeer AI pipelines work, including ComfyStream and BYOC.
      </Card>
      <Card title="Daydream" icon="wand-magic-sparkles" href="/v2/platforms/products/daydream/daydream" arrow>
  ...
  <Tab title="I want to run a gateway">
    ...
    **Start here:**
    ...
    <CardGroup cols={2}>
      ...
      <Card title="Gateway Quickstart" icon="bolt-lightning" href="/v2/gateways/run-a-gateway/quickstart/quickstart-a-gateway" arrow>
  ...
  <Tab title="I want to contribute GPU compute">
    ...
    **Start here:**
    ...
    <CardGroup cols={2}>
      <Card title="Orchestrator Portal" icon="microchip" href="/v2/pages/05_orchestrators/orchestrators-portal" arrow>
        Everything you need to set up and run an orchestrator node.
      </Card>
      <Card title="Orchestrator Setup" icon="server" href="/v2/pages/05_orchestrators/setting-up-an-orchestrator" arrow>
  ...
  <Tab title="I want to extend the protocol">
    ...
    **Your path:** Start with the protocol documentation and contract addresses.
    ...
    <CardGroup cols={2}>
      ...
      <Card title="Protocol Economics" icon="chart-line" href="/v2/about/livepeer-protocol/protocol-economics" arrow>
...
<CardGroup cols={3}>
  ...
  <Card title="Video on Demand" icon="video" href="/v2/platforms/products/livepeer-studio/overview/vod-overview" arrow>
  ...
  <Card title="Real-Time AI Video" icon="wand-magic-sparkles" href="/v2/platforms/products/daydream/daydream" arrow>
    Style transfer, StreamDiffusion
  </Card>
  <Card title="Custom AI Pipelines" icon="circuit-board" href="/v2/developers/ai-inference-on-livepeer/ai-pipelines/overview" arrow>
