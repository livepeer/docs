...
import { AptosNft, WagmiNft } from "@components/react/examples";
...
<SyncedTabs group="chain" items={['wagmi', 'aptos']}>
  <SyncedTab>
    ...
    We create both a new livepeer.js client (using a [CORS-protected API key](/reference/livepeer-js/providers/studio#apikey))
