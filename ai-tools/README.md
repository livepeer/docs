...
| `registry/` | Canonical inventory of all `ai-tools/**` artifacts plus the workflow/dispatcher visual library | Governed. See `registry/README.md` |
...
| Browse the canonical workflow and dispatcher visual library | `registry/workflows/index.mdx` and `registry/dispatchers/index.mdx` |
