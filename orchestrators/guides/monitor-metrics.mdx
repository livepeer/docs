...
This guide provides instructions on configuring metrics monitoring for orchestrators that have been [activated](/orchestrators/guides/get-started#activate) on the Livepeer network.
