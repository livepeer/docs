...
There is a separate binary which supports transcoding on the NVIDIA GPU. The requirement for this binary is to have version 11 of the [CUDA Toolkit](https://developer.nvidia.com/cuda-11-7-0-download-archive) installed on your machine.
