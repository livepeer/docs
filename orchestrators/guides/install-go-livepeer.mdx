...
There is a separate binary which supports transcoding on the NVIDIA GPU. The requirement for this binary is to have [CUDA Toolkit](https://developer.nvidia.com/cuda-toolkit) installed on your machine. As of the time of writing, it is advised to use version 11.7.1 of the CUDA Toolkit for optimal compatibility and performance.
