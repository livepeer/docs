...
- Access to a [hosted or self-hosted Arbitrum node](/orchestrators/guides/connect-to-arbitrum)
...
- Use the `-ethUrl` flag to [connect to the arbitrum network](/orchestrators/guides/connect-to-arbitrum) using a hosted or self hosted Arbitrum node.
