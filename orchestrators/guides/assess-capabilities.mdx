...
Once you have confirmed that your [hardware](/references/go-livepeer/gpu-support) is supported by `Go Livepeer`, you should assess how many concurrent streams it can support.
...
You can test the performance of your card using the `livepeer_bench` [benchmarking tool](/orchestrators/guides/benchmark-transcoding).
