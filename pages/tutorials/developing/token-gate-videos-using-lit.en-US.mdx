---
title: 'How to Token Gate Videos Using Livepeer and Lit: A Step-by-Step Tutorial'
description: 'Learn how to token gate videos using Livepeer and Lit: A step-by-step tutorial'
type: 'tutorial'
category: 'developing'
ogImageText: 'Token Gate Videos Using Livepeer and Lit: A Step-by-Step Tutorial'
---
...
In this tutorial, we will be using different packages and SDKs which means we have to setup up the context and clients for each of them. Let’s start with RainbowKit and WAGMI
