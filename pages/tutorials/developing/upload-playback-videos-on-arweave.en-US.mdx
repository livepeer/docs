---
title: 'The Ultimate Guide to Uploading and Streaming Videos on Arweave with Bundlr and Livepeer'
description: 'Learn how to upload and stream videos on Arweave using Bundlr and Livepeer'
type: 'tutorial'
category: 'developing'
ogImageText: 'Upload and Stream Videos on Arweave with Bundlr and Livepeer'
---
...
{/* ![Untitled](Arweave%20&%20Bundlr%20Network%20c1ac95c52df744bc8d6ce73cb7986e8f/Untitled.png) */}
...
To use Livepeer.js in your project, create a new directory named `client`in the root directory, and add the following code to `livepeer.js`
...
Visit [Bundlr](https://bundlr.network/) to learn more about its capabilities and the service on [Arweave](https://www.arweave.org/).
