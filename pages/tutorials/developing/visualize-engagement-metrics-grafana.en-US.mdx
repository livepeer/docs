...
For more details, check out the docs [here](/guides/developing/viewer-engagement).
...
1. Integrated the necessary components to capture viewership data. Detail [here](/guides/developing/viewer-engagement#registering-views).
...
2. Click “Connections” > "Connect Data"
   ...
   ![Grafana Connections](/images/tutorials/granfa-connections.jpg)
...
8. “Import the Dashboard” using your formatted json file
   ...
   ![Grafana Import](/images/tutorials/grafana-import-dashboard.jpg)
