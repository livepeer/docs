...
3. Created an CORS-enabled API Key [here](https://livepeer.com/dashboard/developers/api-keys). The key must allow CORS access from your Grafana origin, or from all (\*)
...
2. Click “Connections” > "Connect Data"
   <img src="/images/tutorials/grafana-connections.jpg" alt="" width="30%" />
...
8. “Import the Dashboard” using your formatted json file
   <img src="/images/tutorials/grafana-import-dashboard.jpg" title="Grafana Import" width="30%" />
