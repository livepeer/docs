...
3. Created an CORS-enabled API Key [here](https://livepeer.studio/dashboard/developers/api-keys). The key must allow CORS access from your Grafana origin, or from all (\*)
...
2. Click “Connections” > "Connect Data"
   <img src="/images/tutorials/grafana-connections.jpg" title="Grafana Connections" width="30%" />
