---
title: 'Optimize Latency with Livepeer Studio'
description: 'Learn how to achieve the optimal blend of latency and quality with Livepeer Studio'
type: 'tutorial'
category: 'developing'
---
...
**WebRTC delivers video with ultra-low latency of 0 - 3 seconds.**
...
- [Playing WebRTC Livestreams with the Livepeer Player](/guides/developing/player#using-the-livepeerjs-player)
- [Playing WebRTC Livestreams with other clients](/guides/developing/player#webrtc-low-latency-livestreams)
...
- [Selecting the Livepeer Studio preset](/guides/developing/stream-via-obs#input-your-stream-settings)
- [Optimizing OBS for low latency](/guides/developing/stream-via-obs#optimizing-for-low-latency)
- [Optimizing for Stream Quality](/guides/developing/stream-via-obs#optimizing-for-stream-quality-and-user-experience)
...
- [Sample settings](/guides/developing/stream-via-obs#recommended-obs-settings)
...
- [Implement the customizable React component](/guides/developing/stream-via-browser#using-livepeerjs-broadcast)
- [Embed a hosted version](/guides/developing/stream-via-browser#embeddable-broadcast)
- [Roll your own broadcasting experience with plain WebRTC](/guides/developing/stream-via-browser#adding-broadcasting-with-plain-webrtc)
...
Our defaults can be found [here](https://github.com/livepeer/livepeer.js/blob/47e572880224739f538e75ef192bb290b85a852f/packages/core-web/src/media/browser/hls/index.ts#L55-L61). Please note that this config is a starting point that we feel is a good balance for latency, quality, rebuffering, etc.
