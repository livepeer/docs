...
1. Integrated the necessary components to capture viewership data. Detail ![here](https://docs.livepeer.org/guides/developing/viewer-engagement.en-US#registering-views).
...
3. Set up a Grafana account and workspace. A free account is sufficient and available at [Grafana.com](https://grafana.com/)
...
2. Click “Connections” > "Connect Data"
    ...
    ![Grafana Connections](/images/tutorials/grafana-connections.jpg)
...
6. Get your data source’s `uid` from the url
    1. e.g. `<your-grafana-url>/grafana/connections/your-connections/datasources/edit/<datasource-uid>`
...
8. “Import the Dashboard” using your formatted json file
    ...
    ![Grafana Import](/images/tutorials/grafana-import-dashboard)
