...
- Create a stream by navigating to "Streams", clicking "Create stream". Naming it whatever you'd like.
- Copy the generated "Stream key" in the stream detail view. You'll need this to stream into OBS.
...
<Callout>
  The RTMP ingest URL and stream key can be found inside the Livepeer Studio 
  stream detail view.
</Callout>
...
2. Navigate back to Livepeer Studio and select the stream name that
