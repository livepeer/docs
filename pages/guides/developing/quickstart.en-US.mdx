...
| Livestream | `GET /api/session/{id}`  | [Retrieve a session by ID](../../reference/api/get-stream)| 
| Livestream | `PATCH /api/stream/{id}`  | [Update a specific stream by ID](../../reference/api/update-stream) | 
...
| On Demand| `POST /api/asset/{id}/export`  | [Export an asset (e.g. to IPFS)](../../reference/api/update-asset#updating-storage) | 
