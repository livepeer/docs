...
First, go to the [Livepeer Studio Dashboard](https://livepeer.studio/dashboard). Click `Create API Key`. A dialogue should appear.
...
1. [Upload a video](/guides/developing/view-asset)
2. [Create a livestream](/guides/developing/view-stream)
