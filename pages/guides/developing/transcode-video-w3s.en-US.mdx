...
You can playback the transcoded video from web3.storage using this URL with any HLS player. For example, `https://lvpr.tv/?url=https://bafybeiakkypfc7uzk6jnk6pg3f2fwumkahrmgbii7cigyyc7oejjo3ff4e.ipfs.w3s.link/index.m3u8` will playback the video using the hosted Livepeer player.
