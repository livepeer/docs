...
> **Note:** It is recommended you complete the steps in [Benchmark transcoding](/guides/orchestrating/benchmark-transcoding) before proceeding.
...
> **Note:** [Bandwidth Requirements](/reference/go-livepeer/bandwidth-requirements) provides further information about testing your available upload/download bandwidth.
