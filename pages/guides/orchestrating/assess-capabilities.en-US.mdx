...
Once you have confirmed that your [hardware](/reference/go-livepeer/gpu-support) is supported by Livepeer, you should assess how many concurrent streams it can support.
