...
This guide provides instructions on configuring metrics monitoring for orchestrators that have been [activated](/guides/orchestrating/getting-started/activation) on the Livepeer network.
...
> **Note:** You can refer to [Prometheus Metrics](/reference/go-livepeer/prometheus-metrics) to check what metrics are exposed.
