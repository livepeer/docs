...
| `playback.accessControl`   | A specialized webhook for playback access control. Unlike an event, it enables the application of access control policies to content.                                  |
