...
When true, the Player will play back livestreams with low-latency WebRTC. If this does not succeed in
...
This only applies to video elements which are playing back livestreams. Defaults to false.
