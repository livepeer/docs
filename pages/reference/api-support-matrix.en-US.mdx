...
| Video Delivery Location   | Supported tested: EU, US Supported untested: Asia, South America, Australia, Africa                                                                                                                 |
| Live stream recording     | Only available for paying users. HLS playback URL (m3u8) is available 5 minutes after the session ends. Livepeer.studio stores recording and serves playback via CDN. The limit to the recording length is up to 12 hours max. |
