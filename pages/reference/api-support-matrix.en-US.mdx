...
| Encoder Software             | Supported tested: OBS 25.0.8, ffmpeg 4.3, Streamaxia <br/>Supported untested: Xsplit, other versions of OBS and ffmpeg, other RTMP encoders, SRT encoders <br/>Unsupported: WebRTC                     |
| Framerate                    | Between 5fps and 60fps, passthrough or custom                                                                                                                                               |
| GOP Size (Keyframe Interval) | Supported tested: Constant GOP, Variable GOP of 0.5s to 8s <br/>Supported untested: Xsplit, Other versions of OBS and ffmpeg, other RTMP encoders <br/>Unsupported: Variable GOP not within 0.5s to 8s |
...
| FPS                       | Supported tested: 24, 25, 30, 60 fps, uniform across all renditions <br/> Supported untested: custom fps, uniform across all renditions |
| Resolution                | Supported tested: Custom resolution up to 1080p <br/> Supported untested: Custom resolution up to 4k                                    |
...
| Low latency              | A target range of 3-5s for transcoded renditions and sub-second for the source                                                                        |
| Live output format        | HLS playback URL (m3u8), WHEP WebRTC playback                                                                                                                                                                            |
| H264 Transcoding Profiles | Baseline, Main, High                                                                                                                                                                               |
| Video players             | Supported tested: livepeer.js, video.js, hls.js, safari/ios native player, Theoplayer; <br/> Supported untested: JWPlayer, android native, Shaka, Exo, Bitmovin, Brightcove                              |
| Video Delivery Location   | Supported tested: EU, US <br/> Supported untested: Asia, South America, Australia, Africa                                                                                                                 |
