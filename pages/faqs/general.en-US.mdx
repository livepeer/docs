...
## What is the pricing for using Livepeer?
...
We take down any stream that we believe to be infringing copyrights, regardless of the subscription level with us.
...
## How do I change my password for Livepeer?
...
## How do I see the status of the Livepeer network?

You can visit the status page here: https://livepeer.statuspage.io.

## Can I create an API key without using the dashboard?
