---
title: What is the Livepeer AI Network?
icon: microchip-ai
iconType: regular
---

<Warning>
  The Livepeer _AI Video Network_ is in its Alpha phase. Bugs or issues may be
  ...
  is invaluable for enhancing the Livepeer AI Network. Thank you for your contributions!
</Warning>

The **Livepeer AI Video Network**, also known as the **Livepeer AI Network**, is the first step
...
your journey with the Livepeer AI Network.
...
<CardGroup cols={3}>
  ...
  {/* <Card
    ...
    title="Contribute to Livepeer AI Network"
    icon="heart"
    iconType="duotone"
  >
    Contribute to the Livepeer AI Network and help shape the future of AI on Livepeer.
  </Card> */}
  <Card
    ...
    iconType="duotone"
  >
    Explore the Livepeer AI Network API to integrate AI capabilities into your projects.
  </Card>

</CardGroup>

## Background on the Livepeer AI Network

The Livepeer AI Network, initially proposed in
...
Designed to revolutionize creative processes, the Livepeer AI Network reflects Livepeer's
commitment to creating a **globally accessible open video infrastructure**.
Livepeer's AI Network aims to empower users to leverage any form of image and
...
### Advantages of Livepeer's AI Network
...
The Livepeer AI Network, built on the established Livepeer network, leverages a
...
requested the task. This architecture ensures the Livepeer AI Network is both
**efficient** and **flexible**, ready to scale and adapt to various AI
applications.

### Explore Generative AI Pipelines

The Livepeer AI Network hosts a variety of generative AI pipelines, each supporting
...
- **Alpha Phase**: The Livepeer AI Network is currently in its Alpha phase, and users may
  encounter bugs or issues during this early stage. It is not yet meant to be
  used with high demand production workloads.
- **Supports Limited Set of Open-source Models**: The Livepeer AI Network currently
  ...
  the future.
- **Only Higher VRAM GPUs Supported**: Currently, the Livepeer AI Network requires GPUs
...
### Livepeer AI Network Terminology

- **Mainnet Transcoding Network**: Comprises Orchestrator and Gateway nodes that
  perform or coordinate transcoding tasks.
- **Livepeer AI Network (also known as Livepeer AI Video Network)**: A specialized Network within the
