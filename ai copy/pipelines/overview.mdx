...
The Livepeer AI Network offers a variety of **generative AI pipelines** that applications
...
example. For a comprehensive guide on integrating the Livepeer AI Network into your
...
During the **Alpha** phase of the Livepeer AI Network, Orchestrators are encouraged to
...
<CardGroup cols={2}>
  ...
  <Card title="Segment-Anything-2" icon="video" href="/ai/pipelines/segment-anything-2">
    The segment-anything-2 pipeline segments anything in images and videos
  </Card>
</CardGroup>
