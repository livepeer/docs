...
The `image-to-video` pipeline of the Livepeer AI Network allows you to generate animated
...
<Tip>
  ...
  experiment with the API, see the [Livepeer AI Network API
...
[Livepeer AI Network API Reference](/ai/api-reference/image-to-video).
...
>
  Explore the `image-to-video` endpoint and experiment with the API in the Livepeer AI
