 ...
 * @usage       node tools/scripts/automations/ai/agents/cross-agent-packager.js [flags]
 * @policy      R-R27, R-R30
 */
...
function buildTopReadme(pipelineSkills) {
  ...
  lines.push('');
  lines.push('Generated by: `node tools/scripts/automations/ai/agents/cross-agent-packager.js --agent-pack all`');
  lines.push('');
  return `${lines.join('\n')}\n`;
}
...
function buildRulePackMarkdown(agentName, pipelineSkills, referenceSkills) {
  ...
  lines.push('Run source: `node tools/scripts/automations/ai/agents/cross-agent-packager.js --agent-pack all`');
  lines.push('');
  return `${lines.join('\n')}\n`;
}
