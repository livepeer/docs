...
| `tools/scripts/validators/components/check-component-docs.js` | Validates component JSDoc coverage, prop documentation, and docs-entry coverage for exported components under snippets/components. | `node tools/scripts/validators/components/check-component-docs.js [--path snippets/components] [--base-ref docs-v2]` | docs |
