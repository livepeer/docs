...
<Info>
  ...
  and inherits all of the documentation for those child components.
</Info>
...
`LiveIndicator` provides a visual notification of live streaming, enabling
viewers to easily discern the live status of the media.
