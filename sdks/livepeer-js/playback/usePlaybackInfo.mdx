...
Hook for retrieving playback information related to a playback ID. Used internally in the [`Player`](/sdks/livepeer-js/Player)
...
The `usePlaybackInfo` hook also supports any [Tanstack Query](https://tanstack.com/query/v4/docs/reference/useQuery) `useQuery` options, such as
...
The `usePlaybackInfo` hook also comes with a [Tanstack Query](https://tanstack.com/query/v4/docs/guides/ssr) prefetch query, `prefetchPlaybackInfo`,
