...
Hook for retrieving a [Stream Session](https://github.com/livepeer/livepeer-react/blob/main/packages/core/src/types/provider.ts)
...
The `useStreamSession` hook also supports any [Tanstack Query](https://tanstack.com/query/v4/docs/reference/useQuery) `useQuery` options, such as
...
The `useStreamSession` hook also comes with a [Tanstack Query](https://tanstack.com/query/v4/docs/guides/ssr) prefetch query, `prefetchStreamSession`,
