...
Hook for creating a new [Stream](https://github.com/livepeer/livepeer-react/blob/main/packages/core/src/types/provider.ts).
...
<Warning>
  ...
  [`Player`](/sdks/livepeer-js/Player).
</Warning>
...
The return value is partially based on [Tanstack Query](https://tanstack.com/query/v4/docs/reference/useMutation), with some return types
...
The `mutationConfig` parameter allows for any [Tanstack Query](https://tanstack.com/query/v4/docs/reference/useMutation) `useMutation` options, such as
