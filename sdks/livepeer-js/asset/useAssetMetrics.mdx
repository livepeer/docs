...
The following examples assume an ID has been created for an asset, and the [`Player`](/sdks/livepeer-js/Player)
...
The `useAssetMetrics` hook also supports any [Tanstack Query](https://tanstack.com/query/v4/docs/reference/useQuery) `useQuery` options, such as
...
The `useAssetMetrics` hook also comes with a [Tanstack Query](https://tanstack.com/query/v4/docs/guides/ssr) prefetch query, `prefetchAssetMetrics`,
