...
Hook for retrieving an [asset](https://github.com/livepeer/livepeer-react/blob/main/packages/core/src/types/provider.ts)
...
The `useAsset` hook also supports any [Tanstack Query](https://tanstack.com/query/v4/docs/reference/useQuery) `useQuery` options, such as
...
The `useAsset` hook also comes with a [Tanstack Query](https://tanstack.com/query/v4/docs/guides/ssr) prefetch query, `prefetchAsset`,
