...
const doubleHeadersValidator = require('../scripts/validators/content/structure/validate-double-headers');
const mdxSafeMarkdownValidator = require('../scripts/validators/content/structure/validate-mdx-safe-markdown');
