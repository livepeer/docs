 ...
 * @scope             tests/unit, operations/scripts/sync-codex-skills.js, ai-tools/ai-skills/templates
 * @owner             docs
 * @needs             R-R27, R-R30
...
const SYNC_SCRIPT = path.join(REPO_ROOT, 'operations/scripts/sync-codex-skills.js');
