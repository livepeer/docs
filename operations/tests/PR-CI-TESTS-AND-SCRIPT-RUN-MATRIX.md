...
| **tools/scripts** |  |  |  |
| `operations/scripts/audit-component-usage.js` | Utility script for operations/scripts/audit-component-usage.js. | Manual/on-demand (no direct hook/workflow reference found) | `node operations/scripts/audit-component-usage.js` |
| `operations/scripts/debug-mint-dev.js` | Utility script for operations/scripts/debug-mint-dev.js. | Manual/on-demand (no direct hook/workflow reference found) | `node operations/scripts/debug-mint-dev.js` |
| `tools/dev/add-callouts.js` | Utility script for tools/dev/add-callouts.js. | Manual/on-demand (no direct hook/workflow reference found) | `node tools/dev/add-callouts.js` |
...
| `tools/dev/test-add-callouts.js` | Utility script for tools/dev/test-add-callouts.js. | Manual/on-demand (no direct hook/workflow reference found) | `node tools/dev/test-add-callouts.js` |
...
| `operations/scripts/new-script.js` | Create a new script file prefilled with the required docs header template. | Manual/on-demand (no direct hook/workflow reference found) | `node operations/scripts/new-script.js --path tests/integration/my-script.js` |
| `operations/scripts/snippets/fetch-external-docs.sh` | Utility script for operations/scripts/snippets/fetch-external-docs.sh. | Manual/on-demand (no direct hook/workflow reference found) | `bash operations/scripts/snippets/fetch-external-docs.sh` |
...
| `operations/scripts/test-v2-pages.js` | Utility script for operations/scripts/test-v2-pages.js. | PR CI: `Docs CI - V2 Browser Sweep` full-route browser sweep<br />npm script `tools:test:all-pages` (manual/local)<br />npm script `tools:test:v2-pages` (manual/local) | `node operations/scripts/test-v2-pages.js` |
