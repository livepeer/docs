#!/usr/bin/env node
/**
 * @script      dispatch-exchanges-data
 * @type        dispatch
 * @concern     maintenance
 ...
 * @usage       node operations/scripts/dispatch/content/maintenance/dispatch-exchanges-data.js [--mode pr|scheduled|manual] [--dry-run|--write] [--verify]
...
function main() {
  ...
  if (args.help) { printPipelineHelp('dispatch-exchanges-data.js', 'exchanges-data'); process.exit(0); }
