#!/usr/bin/env node
/**
 * @script      dispatch-contract-shadow
 * @type        dispatch
 * @concern     maintenance
 ...
 * @usage       node operations/scripts/dispatch/content/maintenance/dispatch-contract-shadow.js [--mode pr|scheduled|manual] [--dry-run|--write] [--verify]
...
function main() {
  ...
  if (args.help) { printPipelineHelp('dispatch-contract-shadow.js', 'contract-shadow'); process.exit(0); }
