#!/usr/bin/env node
/**
 * @script      dispatch-governance-sync
 * @type        dispatch
 * @concern     governance
 * @niche       meta
 ...
 * @usage       node operations/scripts/dispatch/governance/dispatch-governance-sync.js [--dry-run|--write] [--verify]
...
const PIPELINES = ["dispatch-root-governance.js","dispatch-folder-allowlist.js","dispatch-governance-map.js"].map((f) => path.join(REPO_ROOT, 'operations/scripts/dispatch/governance', f));
