#!/usr/bin/env node
/**
 * @script      dispatch-script-locations
 * @type        dispatch
 * @concern     governance
 ...
 * @usage       node operations/scripts/dispatch/governance/dispatch-script-locations.js [--mode pr|scheduled|manual] [--dry-run|--write] [--verify]
...
function main() {
  ...
  if (args.help) { printPipelineHelp('dispatch-script-locations.js', 'script-locations'); process.exit(0); }
