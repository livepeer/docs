#!/usr/bin/env node
/**
 * @script      dispatch-codex-compliance
 * @type        dispatch
 * @concern     governance
 ...
 * @usage       node operations/scripts/dispatch/governance/dispatch-codex-compliance.js [--mode pr|scheduled|manual] [--dry-run|--write] [--verify]
...
function main() {
  ...
  if (args.help) { printPipelineHelp('dispatch-codex-compliance.js', 'codex-compliance'); process.exit(0); }
