#!/usr/bin/env node
/**
 * @script      dispatch-script-registry
 * @type        dispatch
 * @concern     governance
 ...
 * @usage       node operations/scripts/dispatch/governance/dispatch-script-registry.js [--mode pr|scheduled|manual] [--dry-run|--write] [--verify]
...
function main() {
  ...
  if (args.help) { printPipelineHelp('dispatch-script-registry.js', 'script-registry'); process.exit(0); }
