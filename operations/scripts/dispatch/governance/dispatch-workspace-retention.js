#!/usr/bin/env node
/**
 * @script      dispatch-workspace-retention
 * @type        dispatch
 * @concern     governance
 ...
 * @scope       workspace/
 * @usage       node operations/scripts/dispatch/governance/dispatch-workspace-retention.js [--mode pr|scheduled|manual] [--dry-run|--write] [--verify]
...
function main() {
  ...
  if (args.help) { printPipelineHelp('dispatch-workspace-retention.js', 'workspace-retention'); process.exit(0); }
