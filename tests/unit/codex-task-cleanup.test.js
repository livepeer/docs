 ...
 * @scope             tests/unit, tools/scripts/automations/ai/codex/task-cleanup.js
 * @owner             docs
 * @needs             R-R27, R-R30
...
const SCRIPT_PATH = path.join(REPO_ROOT, 'tools/scripts/automations/ai/codex/task-cleanup.js');
