...
Network and playback the transcoded version of it using livepeer.js.
...
transcode, and serve video content. The Livepeer.js JavaScript SDK provides a
...
To use Livepeer.js in your project, create a new directory named `client`in the
root directory, and add the following code to `livepeer.js`
