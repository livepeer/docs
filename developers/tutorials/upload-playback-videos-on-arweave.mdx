...
Network and playback the transcoded version of it using Livepeer Kit.
...
transcode, and serve video content. The Livepeer Kit SDK provides a set of
...
To use Livepeer Kit in your project, create a new directory named `client`in the
