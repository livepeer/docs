...
upload, transcode, and serve video content. The Livepeer Kit SDK provides a set
of ready-to-use hooks that make it easy to integrate Livepeer into a project.
...
To use Livepeer Kit in your project, create a new directory named `client` in
