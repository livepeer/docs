...
description: "Learn how to mint a video NFT on the Aptos or an EVM-compatible blockchain with Livepeer React"
---

Livepeer is blockchain agnostic. The example below shows how to mint a video NFT using either [`wagmi`](https://wagmi.sh/) for EVM-compatible blockchains or
[`aptos`](https://aptos.dev/) for the Aptos blockchain. However, you can use Livepeer to mint NFTs with any blockchain by following the chain-specific NFT standards.
