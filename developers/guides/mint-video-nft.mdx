...
<Tabs>
  <Tab title="Ethereum">
    ...
    We create both a new livepeer.js client (using a [CORS-protected API key](/sdks/livepeer-js/providers/studio#apikey))
...
<Tabs>
  <Tab title="Ethereum">
    <Info>
      ...
      dynamic (see the [WagmiNft component](https://github.com/livepeer/livepeer.js/blob/livepeer%402.1.4/docs/components/examples/WagmiNft.tsx)
