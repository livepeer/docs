...
description:
  "Learn how to add access control to a content with Livepeer Kit, using JWTs"
---
...
Then, we pass the JWT to the Player using the [`jwt`](/kit/player/Root#jwt)
prop, which will use that JWT to prove access to the content!
