...
<Tabs>
  ...
  <Tab title="Go">
    ...
    func main() {
      ...
      resp, err := client.Metrics.GetPublicViewership(context.Background(), playbackId)
      if err != nil {
...
<Tabs>
  ...
  <Tab title="Go">
    ...
    func main() {
      ...
      assetID := "<ASSET_ID>"
      timeStep := operations.GetCreatorViewershipMetricsQueryParamTimeStep("day")
      breakdownBy := []operations.GetCreatorViewershipMetricsQueryParamBreakdownBy{"timezone"}

      resp, err := client.Metrics.GetCreatorViewership(context.Background(), operations.GetCreatorViewershipMetricsRequest{
        AssetID:     &assetID,
        TimeStep:    &timeStep,
        BreakdownBy: breakdownBy,
      })
...
<Tabs>
  ...
  <Tab title="Go">
    ...
    func main() {
      ...
      breakdownBy := []operations.BreakdownBy{"timezone"}
      resp, err := client.Metrics.GetUsage(context.Background(), operations.GetUsageMetricsRequest{
        BreakdownBy: breakdownBy,
      })
      if err != nil {
