...
<Tabs>
  <Tab title="Node.js">
    ...
    const playbackId = 'PLAYBACK_ID'; // Replace with the playback ID you want to query
    ...
    livepeer
      .metrics.getPublicTotalViews(playbackId)
      .then((response) => {
...
<Tabs>
  <Tab title="Node.js">
    ...
    const apiToken = 'YOUR_API_TOKEN'; // Replace with your API token
    const assetId = 'ASSET_ID'; // Replace with the asset ID for which you want to query views
    const timeStep = 'day'; // Define the time step
    const breakdownBy = ['timezone']; // Define the breakdown criteria
    ...
    livepeer
      .metrics.getCreatorViewership(queryParams)
      .then((response) => {
...
<Tabs>
  <Tab title="Node.js">
    ...
    livepeer
      .metrics.getPublicTotalViews(queryParams)
      .then((response) => {
