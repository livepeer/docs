...
In this guide, we demonstrate how to playback on demand videos in your application using either Livepeer.js or Video.js.
...
To playback a livestream in other players, you'll need to fetch the playback URL(s).
