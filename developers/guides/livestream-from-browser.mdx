...
Livepeer.js Broadcast React component, or build their own WebRTC solution.

## Using Livepeer.js Broadcast

The example below show to use the Livepeer.js
[`Broadcast`](/sdks/livepeer-js/Broadcast) component to broadcast from the web.
...
[`Broadcast`](/sdks/livepeer-js/Broadcast) with a stream key, from a stream we
