...
The example below show to use Livepeer.js [`Broadcast`](/sdks/livepeer-js/Broadcast) to broadcast from the web.

### Configuring Providers

First, we create a new livepeer.js client with a gateway provider and a [CORS-protected API key](/sdks/livepeer-js/providers/studio#apikey),
