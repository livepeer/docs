...
You can also create and remove multistream targets individually from a given stream using the 
[Create Multistream Target](/api-reference/stream/create-multistream-target) and
[Delete Multistream Target](/api-reference/stream/remove-multistream-target) APIs.
