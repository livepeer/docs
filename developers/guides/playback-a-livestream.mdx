...
[`Player`](/sdks/react/player/Root) with an IPFS CID as our `playbackId`, which
...
[Player's technical details](/sdks/react/player/Root#technical-details) for more
...
<Info>
  ...
  docs](/sdks/react/player/Root#technical-details) for more information.
</Info>
