...
<Tabs>
  ...
  <Tab title="Python">
    ...
    res = lpClient.stream.get(id='STREAM_ID')
  ...
  <Tab title="Ruby">
    ```ruby
      ...
      res = lpClient.stream.create(request=Shared::NewStreamPayload.new(
          name="test_stream",
        ))
  ...
  <Tab title="Go">
    ...
    func main() {
        ...
        res, err := lpClient.Stream.Get(ctx, id)
        if err != nil {
            log.Fatal(err)
        }
...
<Tabs>
  ...
  <Tab title="Python">
    ...
    res = lpClient.session.get(id='SESSION_ID')
  ...
  <Tab title="Ruby">
    ...
    res = lpClient.session.get(path_params=Operations::GetSessionRequest.new(
        id="SESSION_ID"
      ))
  ...
  <Tab title="Go">
    ...
    func main() {
        ...
        ctx := context.Background()
        res, err := lpClient.Session.Get(ctx, id)
        if err != nil {
            log.Fatal(err)
        }
