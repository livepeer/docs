...
If you are using the Livepeer Kit Player, you can use the
[`accessKey`](/kit/player/Root#accesskey) prop to provide your custom access
key, which is then passed to the webhook you created to verify that it is valid.
