...
description:
  "Learn how to add access control to a content with livepeer.js, using webhooks"
---
...
If you are using the Livepeer.js Player, you can use the
[`accessKey`](/sdks/livepeer-js/Player#accesskey) prop to provide your custom
