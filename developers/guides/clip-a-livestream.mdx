...
If you are using HLS.js, it provides an API for getting the program date time, `hls.playingDate`, which can be used
...
[`clipLength` to enable the clipping button](/sdks/livepeer-js/Player#cliplength), alongside the clip callbacks.
