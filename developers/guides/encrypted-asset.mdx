...
Livepeer enables you to upload encrypted video content or import it from decentralized storages. It creates a playback URL that can have independent access control through Livepeer's [access control](/developers/guides/overview#access-control) feature.
