...
The following steps assume that you have already created a [Livepeer Studio account](https://livepeer.studio/) and an [API key](https://docs.livepeer.org/developers/guides/quickstart).
