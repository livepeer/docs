...
In this example, we will use the [Livepeer Kit SDK](/kit/getting-started) to
upload a video. Make sure to setup a react app first.
...
Next, create a new [React client](/kit/getting-started) and wrap the app with
`LivepeerConfig`.
