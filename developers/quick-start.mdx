...
In this example, we will use the [Livepeer React SDK](/sdks/livepeer-js/getting-started) to upload a video. Make sure to setup a react app first.
...
Next, create a new [livepeer.js client](/sdks/livepeer-js/getting-started) and wrap the app with `LivepeerConfig`.
...
Once the asset is upload, you will also receive a [asset object](/api-reference/asset/upload) in response.
You can view the asset on Livepeer Studio:
