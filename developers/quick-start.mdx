...
[Livepeer React SDK](/sdks/livepeer-js/getting-started) to upload a video. Make
...
Next, create a new [livepeer.js client](/sdks/livepeer-js/getting-started) and
wrap the app with `LivepeerConfig`.
