...
transcoding and AI inference jobs. Unlike Orchestrators, Gateways do not need a GPU to participate.
Any machine with a decent CPU and sufficient bandwidth can operate as a Gateway.
