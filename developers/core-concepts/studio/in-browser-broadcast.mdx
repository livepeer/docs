...
![Studio - In Browser Broadcast](/images/studio-in-browser-stream.png)
...
- A WebRTC connection is created within a web application using the stream key.
  ...
  - Optionally, a developer can use the livepeer.js Broadcast component to do
    this automatically, given a stream key.
