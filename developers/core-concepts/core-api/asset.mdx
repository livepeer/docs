...
When an Encrypted asset is uploaded to Livepeer, a playback URL is generated. Access to this URL and the contents of the Encrypted asset can be controlled through [access control](/developers/guides/overview#access-control), ensuring content security and selective accessibility.
