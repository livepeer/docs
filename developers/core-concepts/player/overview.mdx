...
- [Asset playback](/developers/guides/playback-an-asset) prioritizes
  [MP4 renditions](/sdks/livepeer-react/Player#mp4-playback-urls), which are cached
...
There is also [custom retry logic](/sdks/livepeer-react/Player#technical-details)
in the Player to make sure that if a livestream is offline or there are any
