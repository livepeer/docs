...
- [Asset playback](/developers/guides/playback-an-asset) prioritizes
  [MP4 renditions](/kit/player/Root#mp4-playback-urls), which are cached with a
  CDN for rapid delivery
...
There is also [custom retry logic](/kit/player/Root#technical-details) in the
