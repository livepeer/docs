...
| 渠道 | 最佳适用 | 响应时间 |
|---|---|---|
| [Discord `#lounge`](https://discord.gg/55SZFEEH5y) | 构建者问题，通用开发 | 小时 |
| [Discord `#ai-research`](https://discord.gg/55SZFEEH5y) | AI 推理，ComfyUI，管道 | 小时 |
| [Discord `#delegating`](https://discord.gg/55SZFEEH5y) | 质押，委托，LPT | 小时 |
| [Discord `#governance`](https://discord.gg/55SZFEEH5y) | 协议提案，治理投票 | 小时–天 |
...
**邀请：** [discord.gg/55SZFEEH5y](https://discord.gg/55SZFEEH5y)
