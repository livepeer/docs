...
- **编写可读的提交信息** — 使用 [Conventional Commits](https://www.conventionalcommits.org/) 格式，仓库要求时使用：`fix:`、`feat:`、`docs:`、
- **等等。**添加测试
- ** — 在添加功能或修复错误时，包括覆盖新或更新行为的测试用例。**更新变更日志`go-livepeer` — `CHANGELOG_PENDING.md` 和其他仓库要求在每个 PR 中更新 
