...
3. Ajoute des métadonnées PNG `og:image` canoniques en utilisant des assets de section pour les routes `docs.json` et l'image de secours pour les pages non routables ou les rapports internes générés
