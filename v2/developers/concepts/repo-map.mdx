...
<CustomDivider middleText="Gateway API and Operator Tools" />
...
<CustomDivider middleText="Application SDKs" />
...
<CustomDivider middleText="Agent and Creative Tooling" />

## Agent and Creative Repositories

Agent SDKs and frameworks built on top of the network. Several packages are not yet published to npm.
...
<CustomDivider middleText="Monitoring and Observability" />
...
<CustomDivider middleText="Governance and Coordination" />
...
<CustomDivider middleText="Documentation and Indexing" />
...
<CustomDivider middleText="Solutions" />
...
<CustomDivider middleText="Cross-Layer Dependencies" />
