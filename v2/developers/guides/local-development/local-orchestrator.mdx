...
<CustomDivider middleText="Standalone Transcoder Mode" />
...
<CustomDivider middleText="With Ethereum (Full Orchestrator)" />
...
<CustomDivider middleText="AI-Only Mode" />
...
<CardGroup cols={2}>
  ...
  <Card title="PyTrickle Quickstart" icon="code" href="/v2/developers/build/ai-and-agents/pytrickle/quickstart" arrow horizontal>
