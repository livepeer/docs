...
<Tabs>
  <Tab title="I want to add video to my app">
    ...
    **Start here:**
    ...
    <CardGroup cols={2}>
      <Card title="Video Streaming Quickstart" icon="tower-broadcast" href="./quickstart/video/video-streaming" arrow>
  ...
  <Tab title="I want to run AI on video">
    ...
    **Start here:**
    ...
    <CardGroup cols={2}>
      <Card title="AI Inference Quickstart" icon="robot" href="./quickstart/ai/ai-pipelines" arrow>
