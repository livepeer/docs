...
<CustomDivider middleText="Pricing Model" />
...
<CustomDivider middleText="Network Pricing Discovery" />
...
<CustomDivider middleText="Setting Prices (Orchestrators)" />
