...
<CardGroup cols={2}>
  <Card title="RFPs & Treasury Proposals" icon="file-contract" href="/v2/developers/learn/where-to-find/opportunities" arrow>
    Apply for Foundation-issued RFPs or propose a funded SPE via the Livepeer onchain treasury.
  </Card>
  <Card title="Open Source Contributions" icon="code-branch" href="/v2/developers/learn/where-to-find/contributing" arrow>
