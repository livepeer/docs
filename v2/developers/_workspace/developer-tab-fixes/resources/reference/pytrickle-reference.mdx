...
The [PyTrickle overview](/v2/developers/build/ai-and-agents/realtime-ai/pytrickle/overview) covers when to use PyTrickle vs ComfyStream. The [FrameProcessor reference](/v2/developers/build/ai-and-agents/realtime-ai/pytrickle/frame-processor) covers the processing API in depth.
