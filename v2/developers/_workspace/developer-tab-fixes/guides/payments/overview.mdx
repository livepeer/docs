...
For batch AI and transcoding, start with [probabilistic micropayments](/v2/developers/guides/payments/probabilistic-micropayments) to understand the ticket mechanism. For live AI billing, start with [per-second compute](/v2/developers/guides/payments/per-second-compute).
