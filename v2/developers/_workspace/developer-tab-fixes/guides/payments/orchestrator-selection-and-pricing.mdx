...
Selection is gateway-side. The gateway queries, filters, and routes; orchestrators advertise and wait. The [probabilistic micropayments](/v2/developers/guides/payments/probabilistic-micropayments) page covers the ticket mechanism that settles each selection.
