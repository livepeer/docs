...
For a production-ready implementation of this pattern, [pymthouse](/v2/developers/guides/payments/clearinghouse-pattern) provides OIDC identity, usage ledger, and remote payment signing out of the box.
