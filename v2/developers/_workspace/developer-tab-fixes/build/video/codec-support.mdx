...
The [transcoding](/v2/developers/build/video/transcoding) page covers transcoding profiles and configuration. The [LPMS integration](/v2/developers/build/video/lpms-integration) page covers the underlying media library.
