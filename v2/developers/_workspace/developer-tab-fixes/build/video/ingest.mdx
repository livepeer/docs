...
After creating a stream, push RTMP from OBS or FFmpeg to the ingest URL. The HLS playback URL is ready as soon as the first segment completes transcoding.
