...
Multistream, recording, and access control are all configurable at stream creation or via update. See [ingest](/v2/developers/build/video/ingest) for the stream creation flow.
