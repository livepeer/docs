...
The ingest-to-playback cycle is the same for all live streams. Add [access control](/v2/developers/guides/auth-and-security/access-control) for gated content or [recording](/v2/developers/build/video/vod-and-recording) for VOD archival.
