...
This is the Persona 3 activation moment. The transcoding quickstart proved the gateway-orchestrator-pipeline lifecycle; this quickstart proves you can plug arbitrary compute into it. The reference applications live at <LinkArrow href="/v2/developers/build/video/transcoding-direct-quickstart" label="transcoding quickstart" newline={false} /> and the SDK at <LinkArrow href="/v2/developers/build/video/transcoding-direct-quickstart" label="transcoding quickstart" newline={false} />.
