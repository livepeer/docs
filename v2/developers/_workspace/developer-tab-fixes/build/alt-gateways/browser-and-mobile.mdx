...
The [AI authentication guide](/v2/developers/guides/auth-and-security/ai-authentication) covers CORS key types and backend key security. The [community gateway](/v2/developers/guides/gateways-as-developer/community-gateway) covers the unauthenticated development endpoint.
