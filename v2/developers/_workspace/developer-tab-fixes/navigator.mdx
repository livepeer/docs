...
<AccordionGroup>
  ...
  <Accordion title="Contribute to the Livepeer protocol codebase" icon="code">
    ...
    **Path: OSS contribution**
    ...
    <LinkArrow href="/v2/developers/learn/where-to-find/contributing" label="Contributor quickstart" />
  ...
  <Accordion title="Evaluate Livepeer for my use case" icon="magnifying-glass">
    ...
    **Path: Evaluation**
    ...
    Start with the infrastructure stack concept page for the access layers, then the AI pipelines page to match your use case to a path.
