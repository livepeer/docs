...
- Use the [AI API portal](/v2/gateways/resources/reference/technical/api-reference/AI-API/ai) when you need network-facing AI endpoints instead of Studio product APIs.
