...
PyTrickle's `StreamServer` implements all four real-time endpoints automatically. See <LinkArrow href="/v2/developers/build/ai-and-agents/pytrickle/overview" label="PyTrickle" newline={false} /> for the implementation pattern.

<CustomDivider middleText="Registration" />
...
<CardGroup cols={2}>
  ...
  <Card title="ComfyStream as BYOC" icon="workflow" href="/v2/developers/build/ai-and-agents/comfystream/comfystream-as-byoc" arrow horizontal>
    Worked example of registering a ComfyStream real-time pipeline as BYOC.
  </Card>
  <Card title="PyTrickle" icon="code" href="/v2/developers/build/ai-and-agents/pytrickle/overview" arrow horizontal>
