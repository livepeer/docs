...
<CustomDivider middleText="Local Setup" />
...
<Steps>
  ...
  <Step title="Scaffold a new plugin">
    ```bash
    naap-plugin create orchestrator-health
...
<CustomDivider middleText="Frontend" />
...
<CustomDivider middleText="Backend" />
...
<CustomDivider middleText="Schema" />
...
<CustomDivider middleText="Inter-Plugin Events" />
...
<CustomDivider middleText="Publication" />
