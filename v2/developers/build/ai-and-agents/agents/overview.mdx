...
<CustomDivider middleText="Framework Integrations" />
...
See <LinkArrow href="/v2/developers/tutorials/eliza-livepeer-plugin" label="Eliza Livepeer Plugin tutorial" newline={false} /> for a full walkthrough of both integrations.

<CustomDivider middleText="Agent Patterns" />
...
<CustomDivider middleText="Custom Agent Runners" />
...
This pattern suits autonomous agents that process jobs continuously rather than on-demand: an agent running a persistent embedding pipeline, a custom vision model, or a specialised audio processor registers once and receives routed jobs as demand arrives on the network.
...
<CustomDivider middleText="VTuber and Streaming Agents" />
...
<CustomDivider middleText="Agent SPE" />
...
<CardGroup cols={2}>
  <Card
    ...
    icon="robot"
    href="/v2/developers/tutorials/eliza-livepeer-plugin"
    arrow
    horizontal
  >
