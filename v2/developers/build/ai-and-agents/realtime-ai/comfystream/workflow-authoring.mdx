...
<CustomDivider middleText="Installing ComfyStream" />
...
<CustomDivider middleText="Building a Streaming Workflow" />
...
<CustomDivider middleText="Starting the Server" />
...
<CustomDivider middleText="Connecting to a Livepeer Gateway" />
