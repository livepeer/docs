...
description: >-
  Core concepts every developer needs before building live streaming apps on
  Livepeer — RTMP, HLS, WebRTC, stream keys, playback IDs, latency modes, and
  the Livepeer pipeline explained.
keywords:
  - livepeer
  - video streaming
  - rtmp
