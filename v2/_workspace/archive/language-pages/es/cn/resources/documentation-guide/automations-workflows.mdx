...
2. 更新 `snippets/data/social-feeds/forumData.jsx`
3. 如果检测到更改则提交并推送
...
2. 更新 `snippets/data/social-feeds/ghostBlogData.jsx`
3. 如果检测到更改则提交并推送
...
2. 过滤掉短视频（≤60 秒）
3. 更新 `snippets/data/social-feeds/youtubeData.jsx`
4. 如果检测到更改，则提交并推送
...
**输出:** `snippets/data/social-feeds/lumaEventsData.jsx`
...
5. 更新 `snippets/data/showcase-feed/showcaseData.jsx`当获得批准时
6. 向提交者发送通知

**输出:** `snippets/data/showcase-feed/showcaseData.jsx`
...
**文件:** `operations/scripts/automations/content/data/fetching/fetch-external-docs.sh`
...
1. 从外部仓库下载文档
2. 对内容进行清理以兼容 MDX
3. 保存到 `snippets/composables/pages/shared/`

**下载到 `snippets/composables/pages/shared/`:**
