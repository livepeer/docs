...
2. Actualiza `snippets/data/social-feeds/forumData.jsx`
...
2. Actualiza `snippets/data/social-feeds/ghostBlogData.jsx`
3. Confirma y envía si se detectan cambios
...
3. Actualiza `snippets/data/social-feeds/youtubeData.jsx`
...
**Salida:** `snippets/data/social-feeds/lumaEventsData.jsx`
...
5. Actualiza `snippets/data/showcase-feed/showcaseData.jsx`cuando sea aprobado
6. Envía notificaciones a los remitentes

**Salida:** `snippets/data/showcase-feed/showcaseData.jsx`
...
**Archivo:** `operations/scripts/integrators/content/data/fetching/fetch-external-docs.sh`
...
3. Guarda en `snippets/composables/pages/shared/`

**Descarga en `snippets/composables/pages/shared/`:**
