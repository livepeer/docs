...
2. Mises à jour `snippets/data/social-feeds/forumData.jsx`
...
2. Met à jour `snippets/data/social-feeds/ghostBlogData.jsx`
...
3. Met à jour`snippets/data/social-feeds/youtubeData.jsx`
...
**Sortie :** `snippets/data/social-feeds/lumaEventsData.jsx`
...
5. Met à jour `snippets/data/showcase-feed/showcaseData.jsx`lorsqu'apprové
6. Envoie des notifications aux soumissionnaires

**Sortie :** `snippets/data/showcase-feed/showcaseData.jsx`
...
**Fichier :** `operations/scripts/automations/content/data/fetching/fetch-external-docs.sh`
...
3. Sauvegarde dans`snippets/composables/pages/shared/`

**Télécharge dans`snippets/composables/pages/shared/`:**
