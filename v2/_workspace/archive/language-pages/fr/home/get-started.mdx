...
<Columns cols={2}>
    ...
    <DisplayCard icon="eyes" title="Just Browsing">
            ...
            <LinkArrow label="Trending at Livepeer" href="/v2/fr/community/connect/trending-topics" description="See what's new across the Livepeer blog, forum, and socials." newline={false} />
    </DisplayCard>
