...
sidebarTitle: Catalogue des scripts
description: >-
...
keywords:
  ...
  - scripts
---
{/* codex-i18n:  */}
<Note>
...
| `tools/scripts/generate-docs-guide-components-index.js` | Générer docs-guide/catalog/components-catalog.mdx à partir des exports de snippets/components et vérifier éventuellement la fraîcheur. | `node tools/scripts/generate-docs-guide-components-index.js --write` | docs |
...
| `tools/scripts/generate-docs-guide-pages-index.js` | Générer docs-guide/catalog/pages-catalog.mdx à partir des entrées v2/index.mdx filtrées pour les pages de navigation docs.json. | `node tools/scripts/generate-docs-guide-pages-index.js --write` | docs |
...
| `operations/scripts/integrators/content/data/fetching/fetch-external-docs.sh` | Script utilitaire pour operations/scripts/integrators/content/data/fetching/fetch-external-docs.sh. | `bash operations/scripts/integrators/content/data/fetching/fetch-external-docs.sh` | docs |
