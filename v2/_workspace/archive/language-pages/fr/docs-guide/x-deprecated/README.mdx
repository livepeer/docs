...
| Catalogue de l'arborescence des pages (généré)                | [pages-catalog.mdx](./catalog/pages-catalog.mdx)                     |
| Catalogue des composants (généré)                | [components-catalog.mdx](./catalog/components-catalog.mdx)           |
| Catalogue des scripts (généré)                    | [scripts-catalog.mdx](./catalog/scripts-catalog.mdx)                   |
| Catalogue des workflows (généré)                  | [workflows-catalog.mdx](./catalog/workflows-catalog.mdx)             |
