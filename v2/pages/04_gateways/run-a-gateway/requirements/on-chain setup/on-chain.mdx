...
<Columns cols={3}>
    ...
    <div>
        ...
        - [Fund Gateway](/v2/pages/04_gateways/run-a-gateway/requirements/on-chain setup/fund-gateway)
...
<Expandable title="REMOVE ME: Old Stuff">
    ...
    **Windows**
    ...
    See <DoubleIconLink label="Fund Your Gateway" href="/v2/pages/04_gateways/run-a-gateway/requirements/on-chain setup/fund-gateway" iconLeft="coins" />
