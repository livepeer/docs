...
<CardGroup cols={2}>
  ...
  >
    <img
  src="../../../assets/products/daydream-logo-dark.svg"
  alt="Daydream Logo"
  className="builderHubCardImage"
/>
  ...
  >
    <img
  src="../../../assets/products/livepeer-studio-logo.svg"
  alt="Daydream Logo"
  className="builderHubCardImage"
/>
  ...
  >
    <img
  src="https://frameworks.network/frameworks-dark-horizontal-lockup-transparent.svg"
  alt="Frameworks Logo"
  className="builderHubCardImage"
/>
