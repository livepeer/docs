...
<CardGroup cols={2}>
  <Card title="Quick Start" icon="bolt-lightning" href="./quick-start" arrow>
...
2. Follow the [Quick Start guide](./quick-start) to build your first integration
3. Explore the [API Reference](../api-reference/overview) for detailed endpoint documentation
4. Check out [Developer Guides](../guides/overview) for common use cases
