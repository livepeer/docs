...
- **Player** — Composable playback (livestream and VOD, WebRTC + HLS/MP4 fallback). See [Player and embed](player-and-embed).
- **Broadcast** — In-browser WebRTC broadcasting. See [Livestream from browser](livestream-from-browser).
