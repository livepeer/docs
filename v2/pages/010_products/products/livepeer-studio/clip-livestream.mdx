...
Clips get **source playback** first (playable quickly); transcoded renditions are added when processing finishes. Use the clip’s `playbackId` with the [Playback Info API](https://livepeer.studio/docs/api-reference/playback/get) or the [Player](player-and-embed) to play it.
