...
See [Player and embed](player-and-embed).
...
Options: `&muted=false`, `&autoplay=false`, `&loop=true`. See [Play a livestream](playback-livestream) for stream-specific options.
