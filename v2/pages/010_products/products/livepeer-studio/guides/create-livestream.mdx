...
- **Playback ID** — Use this in your app to play the stream (e.g. with the [Livepeer Player](player-and-embed) or the [Playback Info API](https://livepeer.studio/docs/api-reference/playback/get)). You can expose the playback ID to viewers.
