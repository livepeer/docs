...
- One example is the [**transparent milestone‑based grant model**](forum.livepeer.org/t/treasury-grant-process/3250): proposers submit budgets and deliverables, funds are released in tranches upon completion and progress is publicly reported on the forum. 
...
## Further Resources
<Card title="Treasury Documentation" icon="piggy-bank" href="../../06_lptoken/treasury/overview.mdx" arrow horizontal > See the Livepeer Treasury documentation in the [LP Token](../../06_lptoken/treasury/overview.mdx) section for comprehensive technical details and guides on voting and porposals. </Card>
<Columns cols={2}>
