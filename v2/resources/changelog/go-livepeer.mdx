...
<Update label="Development — April 2026" description="macOS build fix for pre-built binaries" tags={["Bug Fixes"]} rss={{ title: "go-livepeer development updates — April 2026", description: "Fixed macOS pre-built binary downloads that failed in environments without X11" }}>
  ## Development updates

### Bug fixes

- **Fixed macOS pre-built binary downloads** — Resolved an issue where macOS binaries required X11 to be installed, causing downloads to fail in environments without it. Pre-built macOS binaries now work out of the box again.
