...
<Update label="Week of August 14, 2026 (weekly update)" tags={["Quiet week"]} description="August 14, 2026">
  ## Weekly update — August 14, 2026

  No user-facing changes merged to go-livepeer between August 13 and August 14. Browse the [GitHub releases page](https://github.com/livepeer/go-livepeer/releases) for tagged builds.
</Update>
