...
<Update label="Week of August 21, 2026 (weekly update)" tags={["Quiet week"]} description="August 21, 2026">
  ## Weekly update — August 21, 2026

  No user-facing changes merged to go-livepeer between August 20 and August 21. Browse the [GitHub releases page](https://github.com/livepeer/go-livepeer/releases) for tagged builds.
</Update>
