...
purpose: changelog
audience: everyone
lastVerified: 2026-04-18T00:00:00.000Z
---
...
<Update label="Development" tags={["Bug Fixes"]} rss={{ title: "go-livepeer development updates — April 2026", description: "Fixed macOS pre-built binary downloads that failed in environments without X11" }} description={<Subtitle variant="changelog">April 2026</Subtitle>}>
  ## Development updates
...
<Update label="Development" tags={["BYOC", "Livepeer Box", "Live AI"]} rss={{ title: "go-livepeer development updates — March 2026", description: "BYOC worker auth tokens, webcam input for Livepeer Box, and Live AI session usage tracking" }} description={<Subtitle variant="changelog">March 2026</Subtitle>}>
  ## Development updates
