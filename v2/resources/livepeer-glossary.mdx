...
- **Cmd+K** (Mac) / **Ctrl+K** (Windows) — search across all Livepeer docs
- **Cmd+F** (Mac) / **Ctrl+F** (Windows) — search within this page
- Use the category jump links below to browse by topic
</Tip>

{/* TEMPLATE NOTE: A client-side filterable component would improve this page significantly.
    This is a known enhancement — tracked as a future task. Until then, Cmd+K and Ctrl+F
    are the recommended search paths for users. Include this Tip block in all glossary page templates. */}
