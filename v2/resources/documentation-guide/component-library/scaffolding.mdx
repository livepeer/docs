...
This category currently contains **21** governed export(s).
...
| --- | --- | --- | --- |
| Divider | `deprecated` | `/snippets/components/scaffolding/frame-mode/FrameMode.jsx` | Deprecated alias for FrameModeDivider. Maintained for backwards compatibility. |
| FrameModeDivider | `stable` | `/snippets/components/scaffolding/frame-mode/FrameMode.jsx` | Horizontal rule divider for frame-mode pages. Distinct from elements/spacing/Divider. |
...
### Divider
Use **Divider** when you need deprecated alias for FrameModeDivider. Maintained for backwards compatibility..
Source description: Deprecated alias for FrameModeDivider. Maintained for backwards compatibility.
**Import path**
```jsx
...
Deprecation note: Use FrameModeDivider to avoid collision with elements/spacing/Divider. See `FrameModeDivider`.
**Props**
No documented props.
...
### FrameModeDivider
Use **FrameModeDivider** when you need horizontal rule divider for frame-mode pages. Distinct from elements/spacing/Divider..
Source description: Horizontal rule divider for frame-mode pages. Distinct from elements/spacing/Divider.
**Import path**
```jsx
import { FrameModeDivider } from '/snippets/components/scaffolding/frame-mode/FrameMode.jsx'
```
**Metadata**
- Status: `stable`
- Accepts: `none`
...
### H1
Use **H1** when you need heading override with optional icon prefix for frame-mode pages..
...
| `gap` | `string` | `"var(--lp-spacing-3)"` | No | gap prop. |
| `className` | `string` | `""` | No | CSS class name. |
| `style` | `object` | `{}` | No | Inline style overrides. |
...
### H2
Use **H2** when you need heading override with optional icon prefix for frame-mode pages..
Source description: Heading override with optional icon prefix for frame-mode pages.
**Import path**
```jsx
...
| `gap` | `string` | `"var(--lp-spacing-3)"` | No | Gap between icon and text (default: "var(--lp-spacing-3)") |
| `className` | `string` | `""` | No | CSS class name. |
| `style` | `object` | `{}` | No | Inline style overrides. |
...
### H3
Use **H3** when you need heading override with optional icon prefix for frame-mode pages..
Source description: Heading override with optional icon prefix for frame-mode pages.
**Import path**
```jsx
...
| `iconColor` | `string` | `` | Yes | Color of the icon (default: theme-aware accent color) |
| `align` | `string` | `"left"` | No | Text alignment: "left", "center", "right" (default: "left") |
| `gap` | `string` | `"var(--lp-spacing-2)"` | No | Gap between icon and text (default: "var(--lp-spacing-2)") |
| `className` | `string` | `""` | No | CSS class name. |
| `style` | `object` | `{}` | No | Inline style overrides. |
...
### H4
Use **H4** when you need heading override with optional icon prefix for frame-mode pages..
Source description: Heading override with optional icon prefix for frame-mode pages.
**Import path**
```jsx
...
### H5
Use **H5** when you need heading override with optional icon prefix for frame-mode pages..
Source description: Heading override with optional icon prefix for frame-mode pages.
**Import path**
```jsx
...
### H6
Use **H6** when you need heading override with optional icon prefix for frame-mode pages..
Source description: Heading override with optional icon prefix for frame-mode pages.
**Import path**
```jsx
...
Use **HeroContentContainer** when you need centred content container inside hero sections..
...
Use **HeroImageBackgroundComponent** when you need hero background with image overlay and gradient..
...
### HeroOverviewContent
Use **HeroOverviewContent** when you need hero content layout with title, icon, subtitle, and CTA slots..
...
Use **HeroSectionContainer** when you need full-width hero section wrapper with min-height and gradient background..
...
### LogoHeroContainer
Use **LogoHeroContainer** when you need hero banner with centred logo image, title, and subtitle..
...
### P
Use **P** when you need paragraph override with optional icon prefix for frame-mode pages..
...
### PageHeader
Use **PageHeader** when you need page-level header with icon, title, and subtitle for frame-mode pages..
...
### PortalCardsHeader
Use **PortalCardsHeader** when you need section header with mission label and optional subtitle..
...
Use **PortalContentContainer** when you need outer container for portal page content below the hero..
...
### PortalHeroContent
Use **PortalHeroContent** when you need hero content with logo, title, tagline, description, and card grid..
...
### PortalSectionHeader
Use **PortalSectionHeader** when you need section header with icon, title, and horizontal rule..
...
### RefCardContainer
Use **RefCardContainer** when you need container for reference cards with configurable column count..
...
### Starfield
Use **Starfield** when you need animated canvas starfield background with floating Livepeer logos. Respects prefers-reduced-motion..
