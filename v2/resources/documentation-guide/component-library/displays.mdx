...
| Prop | Type | Default | Required | Description |
| --- | --- | --- | --- | --- |
| `link` | `React.ReactNode` | `` | Yes | Link element (e.g. `<LinkArrow />`), rendered as the heading |
| `iconWrapper` | `React.ReactNode` | `null` | No | Icon badges element (e.g. `<IconBadgeWrapper />`) |
