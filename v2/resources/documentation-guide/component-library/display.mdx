...
// frameMode components commented out - require a legacy theme context (component is immutable)
  ...
  <Tab title="Basic">
    <ScrollableDiagram title="Example Diagram" maxHeight="200px">
      <div style={{ 
        width: "600px", 
        height: "150px", 
        background: "linear-gradient(135deg, var(--accent) 0%, var(--hero-text) 100%)",
        display: "flex",
        alignItems: "center",
