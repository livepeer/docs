...
The governed component library currently exposes **115** named export(s) across five active categories.

### Category Matrix

| Category | Purpose | Exports |
| --- | --- | --- |
| [Primitives](./primitives) | Standalone visual atoms | 28 |
| [Layout](./layout) | Spatial arrangement containers | 27 |
| [Content](./content) | Content formatting and rendering | 24 |
| [Data](./data) | Data-bound feed renderers | 12 |
