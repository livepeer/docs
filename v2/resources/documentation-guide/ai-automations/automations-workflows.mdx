...
- After changing OG branding or localised tab labels
...
- When localised component-library scaffolds need refreshing
...
- ❌ **Deprecated theme helper usage** - Blocks legacy theme helper imports
