...
<Warning>
**MANDATORY:** Read the [Style Guide](../copy-style/style-guide) before making any changes!
</Warning>
...
<CardGroup cols={2}>
  <Card title="Style Guide" icon="palette" href="../copy-style/style-guide" arrow>
...
- Review the [Style Guide](../copy-style/style-guide) for styling guidelines
