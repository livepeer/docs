...
3. Adds canonical PNG `og:image` metadata using section assets for `docs.json` routes and the fallback asset for non-routable or generated internal-report pages
