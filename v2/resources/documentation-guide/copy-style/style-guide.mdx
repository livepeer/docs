...
**See the [Component Library](/v2/resources/documentation-guide/component-library/component-library) for all available custom components.**
...
For full details on the hooks, see the [Git Hooks Documentation](/v2/resources/documentation-guide/contributing/git-hooks).

## Resources

- [Component Library](/v2/resources/documentation-guide/component-library/component-library) - Complete component reference
...
- [Git Hooks Documentation](/v2/resources/documentation-guide/contributing/git-hooks) - Complete pre-commit hook documentation
- `style.css` - Global CSS Custom Properties for theming

## Next Steps

- Review the [Component Library](/v2/resources/documentation-guide/component-library/component-library) for available components
- Check [Snippets Inventory](/v2/resources/documentation-guide/tooling/snippets-inventory) for all available snippets
- Read [Mintlify Repo Guide](/docs-guide/contributing/Mintlify) for repo-safe Mintlify gotchas
- See [Contribute to the Docs](/v2/resources/documentation-guide/contributing/contribute-to-the-docs) for contribution guidelines
