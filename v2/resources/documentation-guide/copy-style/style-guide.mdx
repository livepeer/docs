...
For full details on the hooks, see the [Git Hooks Documentation](/.githooks/README.md).
...
- [Git Hooks Documentation](/.githooks/README.md) - Complete pre-commit hook documentation
