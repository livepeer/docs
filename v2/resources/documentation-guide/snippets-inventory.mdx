...
- Legacy theme styling modules now remain for backwards compatibility only; use CSS Custom Properties in `style.css` for all current work.
...
```jsx
// Import data files
import { GATEWAYS_HREFS } from "/snippets/data/gateways/hrefs.jsx";
...
import OverviewConceptPage from "/snippets/pages/01_ABOUT/concepts/overview.mdx";
```
