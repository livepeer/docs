...
<AccordionGroup>
  <Accordion title="What is Livepeer in one sentence?" icon="circle-info">
      ...
      Start with [Livepeer Overview](/v2/about/concepts/composables/overview) for the full explanation.
    </Accordion>
  ...
  <Accordion title="What is LPT used for?" icon="coins">
      ...
      See [Livepeer Token](/v2/about/protocol/livepeer-token) and [Protocol Economics](/v2/about/concepts/governance-and-economics).
    </Accordion>
