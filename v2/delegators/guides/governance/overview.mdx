...
<Note>
 For Foundation structure, SPE process steps, and community governance participation guidance, see [Governance & the Foundation](/v2/community/ecosystem/governance).
</Note>
...
- Off-chain operational behaviour
...
Governance decisions may indirectly influence network behaviour by modifying:
