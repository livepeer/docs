...
this automatically. See <LinkArrow href="/v2/orchestrators/guides/staking-and-rewards/reward-mechanics" label="Rewards and Fees" newline={false} /> for configuration details.
...
See <LinkArrow href="/v2/orchestrators/guides/staking-and-rewards/delegate-operations" label="Attracting Delegators" newline={false} /> for operator strategies.
