...
<CardGroup cols={3}>
  <Card title="Transcoding Quickstart" icon="film" href="../get-started/quickstart" arrow>
 Canonical setup path available now.
  </Card>
  <Card title="Realtime AI Quickstart" icon="bolt" href="../get-started/realtime-ai-quickstart" arrow>
 Coming soon.
  </Card>
  <Card title="Batch AI Quickstart" icon="boxes-stacked" href="../get-started/batch-ai-quickstart" arrow>
 Coming soon.
  </Card>
</CardGroup>
