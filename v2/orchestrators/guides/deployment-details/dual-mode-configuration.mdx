...
For a full error reference including AI Runner startup failures and capability registration issues, see <LinkArrow href="/v2/orchestrators/resources/reference/faq" label="Orchestrator FAQ" />.
...
<CardGroup cols={2}>
  ...
  <Card title="Orchestrator FAQ" icon="circle-question" href="/v2/orchestrators/resources/reference/faq" arrow horizontal>
