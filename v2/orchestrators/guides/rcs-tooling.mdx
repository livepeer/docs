...
sidebarTitle: Tools
description: >-
  Tools for monitoring, verifying, and operating your Livepeer orchestrator —
  Explorer, payout dashboards, Prometheus metrics, and community tools.
keywords:
  - livepeer
  - orchestrators
  - guides
...
<CardGroup cols={2}>
  <Card title="Earnings and Economics" href="/v2/orchestrators/operations/earnings" />
  <Card title="AI Pipelines" href="/v2/orchestrators/operations/rc-ai-pipelines" />
  <Card title="FAQ and Troubleshooting" href="/v2/orchestrators/resources/faq" />
  <Card title="CLI Flags Reference" href="/v2/orchestrators/resources/technical/cli-flags" />
</CardGroup>
