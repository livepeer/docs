...
<Note>
  **Already running a transcoding orchestrator?** AI pipelines run alongside your existing node using dedicated AI Runner containers. Your transcoding setup does not need to change. See [Batch AI Setup](/v2/orchestrators/guides/ai-and-job-workloads/diffusion-pipeline-setup) for the operator path.
</Note>
