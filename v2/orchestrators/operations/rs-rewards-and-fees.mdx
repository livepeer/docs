...
<Columns cols={2}>
  ...
  <Card title="Economics (About)" icon="book" href="../concepts/rcs-incentives" arrow />
  <Card title="CLI flags (pricing)" icon="terminal" href="../resources/technical/cli-flags" arrow />
</Columns>
