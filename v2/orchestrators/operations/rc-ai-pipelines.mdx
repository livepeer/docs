...
title: AI Pipelines
description: >-
  Configure and optimise AI inference pipelines on your orchestrator — pipeline
  types, aiModels.json reference, custom models, Ollama LLM runner, and remote
  workers.
keywords:
  - livepeer
  - orchestrator
...
If you haven't set up the AI runner yet, start with [Add AI to Your Node](/v2/orchestrators/quickstart/AI-prompt-start). {/* REVIEW: confirm path */}
...
<Note>
The warm model column shows the recommended warm model for early-phase network participation. Operators are free to serve any verified model. For an up-to-date list of verified models per pipeline, see each pipeline's page in the [Livepeer AI docs](https://docs.livepeer.orghttps://docs.livepeer.org/ai/pipelines/overview/overview).
</Note>
...
For a full guide on building and registering custom containers, see [Hosting Models (BYOC)](/v2/orchestrators/operations/r-hosting-models). {/* REVIEW: confirm path */}
...
1. **Not registered** — if you added a new pipeline after initial activation, you may need to re-register your capabilities with the network. Consult the [Activate on the Network](/v2/orchestrators/unclassified/rcs-connect-activate-publish) guide. {/* REVIEW: confirm path */}
...
- [Add AI to Your Node](/v2/orchestrators/quickstart/AI-prompt-start) — initial AI runner setup {/* REVIEW: confirm path */}
- [Hosting Models (BYOC)](/v2/orchestrators/operations/r-hosting-models) — custom model hosting and external containers {/* REVIEW: confirm path */}
- [Hardware Requirements](/v2/orchestrators/setup/rcs-requirements) — VRAM requirements by pipeline {/* REVIEW: confirm path */}
- [CLI Flags Reference](/v2/orchestrators/resources/technical/cli-flags) — full AI worker flag reference {/* REVIEW: confirm path */}
