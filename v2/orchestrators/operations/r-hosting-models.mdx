...
<GotoLink
  ...
  relativePath="../quickstart/x-setup-paths"
/>
...
<CardGroup cols={2}>
  <Card title="BYOC" icon="box" href="https://docs.livepeer.org/ai/pipelines/overview">
 Developer guide to building BYOC containers - how to structure your inference server.
  </Card>
  <Card title="Model Support" icon="microchip-ai" href="https://docs.livepeer.org/ai/pipelines/overview">
 Full model family compatibility matrix - which models work on Livepeer and why.
  </Card>
  <Card title="ComfyStream" icon="diagram-project" href="/v2/developers/get-started/comfystream-quickstart">
 How ComfyStream works as the AI pipeline runtime for orchestrator nodes.
  </Card>
  <Card title="Orchestrator quickstart" icon="rocket" href="../quickstart/x-setup-paths">
