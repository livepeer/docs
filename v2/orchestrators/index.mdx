...
- [Connect to Arbitrum](setup/connect.mdx)
- [Setup Overview](setup/guide.mdx)
- [Monitoring Your Orchestrator Setup](setup/monitor.mdx)
- [Operational and Hardware Requirements for Orchestrators](setup/prepare.mdx)
- [Install go-livepeer](setup/install.mdx)
- [⚠️ Setting up an Orchestrator](setup/s-guide.mdx)
- [Verify Your Setup](setup/verify.mdx)
