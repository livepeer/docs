...
<CardGroup cols={2}>
  <Card title="Orchestrator Job Types" icon="layer-group" href="../concepts/rs-workloads" arrow>
 ...
 Full install options and advanced flags.
  ...
  <Card title="Connect to Arbitrum" icon="plug" href="/v2/orchestrators/unclassified/connect-to-arbitrum" arrow>
