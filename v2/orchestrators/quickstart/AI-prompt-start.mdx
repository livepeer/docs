...
- go-livepeer is installed and running as a transcoding Orchestrator on Arbitrum mainnet (see [Install go-livepeer](/v2/orchestrators/setup/install) and [Get Started](/v2/Orchestrators/quickstart/guide)) {/* REVIEW: confirm target paths */}
...
- Model weights pre-downloaded for the pipeline(s) you want to serve (see [Download AI Models](/v2/orchestrators/guides/ai-and-job-workloads/model-hosting)) {/* REVIEW: confirm path */}

<Note>
This guide adds AI inference to an existing transcoding node. If you are setting up from scratch, start with [Install go-livepeer](/v2/orchestrators/setup/install).
</Note>
...
For details on each pipeline, see [Job Types](/v2/orchestrators/guides/ai-and-job-workloads/workload-options).
...
Check the [AI Pipelines](/v2/orchestrators/guides/ai-and-job-workloads/diffusion-pipeline-setup) documentation for any other pipeline-specific images.
...
For recommended pricing per pipeline, see [Job Types](/v2/orchestrators/guides/ai-and-job-workloads/workload-options). For a full multi-pipeline example, see [AI Pipeline Configuration](/v2/orchestrators/guides/ai-and-job-workloads/diffusion-pipeline-setup). {/* REVIEW: confirm path */}
...
Your AI pipelines will appear in the [Livepeer Explorer](https://explorer.livepeer.org) on your Orchestrator's profile once on-chain capability advertisement is configured. See [Publish Offerings](/v2/orchestrators/setup/connect) for that step. {/* REVIEW: confirm path */}
...
- [Job Types](/v2/orchestrators/guides/ai-and-job-workloads/workload-options) – understand the difference between transcoding, batch AI, real-time AI, and LLM inference before choosing a path
- [AI Pipeline Configuration](/v2/orchestrators/guides/ai-and-job-workloads/diffusion-pipeline-setup) – advanced aiModels.json options, multi-GPU setup, external containers, and optimisation flags {/* REVIEW: confirm path */}
