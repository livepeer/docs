...
- Model weights pre-downloaded for the pipeline(s) you want to serve (see [Download AI Models](/v2/orchestrators/operations/r-hosting-models)) {/* REVIEW: confirm path */}
...
Check the [AI Pipelines](/v2/orchestrators/operations/rc-ai-pipelines) documentation for any other pipeline-specific images.
...
Your AI pipelines will appear in the [Livepeer Explorer](https://explorer.livepeer.org) on your orchestrator's profile once on-chain capability advertisement is configured. See [Publish Offerings](/v2/orchestrators/unclassified/rcs-connect-activate-publish) for that step. {/* REVIEW: confirm path */}
