...
<Columns cols={2}>
  ...
  <Card title="CLI flags reference" icon="terminal" href="/v2/orchestrators/resources/technical/cli-flags" arrow />
  <Card title="Rewards and fees" icon="coins" href="/v2/orchestrators/operations/rs-rewards-and-fees" arrow />
</Columns>
