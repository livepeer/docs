...
1. Ensure the `model_id` values in your `aiModels.json` exactly match the Hugging Face model IDs in the [Livepeer-verified model list](https://docs.livepeer.orghttps://docs.livepeer.org/ai/pipelines/overview/overview).
