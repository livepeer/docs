...
<CardGroup cols={2}>
  <Card title="Pool redirect" icon="users" href="/v2/orchestrators/guides/deployment-details/join-a-pool" arrow>
    Use this if you are contributing GPU capacity to an existing operator instead of setting up your own node.
  </Card>
  <Card title="Other setups" icon="shuffle" href="/v2/orchestrators/navigator" arrow>
...
<CardGroup cols={2}>
  ...
  <Card title="Configure" icon="sliders" href="/v2/orchestrators/setup/configure" arrow>
    Set the runtime flags that define price, GPU selection, network, and service address.
  </Card>
  <Card title="Connect" icon="plug" href="/v2/orchestrators/setup/connect" arrow>
    Connect the node to Arbitrum and verify RPC reliability.
  </Card>
  <Card title="Test" icon="vial" href="/v2/orchestrators/setup/verify" arrow>
...
| Check | Use this page |
| --- | --- |
| Connect | `/v2/orchestrators/setup/connect` |
| Publish and activate | `/v2/orchestrators/setup/connect` |
| Verify | `/v2/orchestrators/setup/verify` |

<CardGroup cols={3}>
  <Card title="Connect" icon="plug" href="/v2/orchestrators/setup/connect" arrow />
  <Card title="Publish" icon="satellite-dish" href="/v2/orchestrators/setup/connect" arrow />
  <Card title="Verify" icon="circle-check" href="/v2/orchestrators/setup/verify" arrow />
</CardGroup>
