...
description: >-
  Install the go-livepeer binary on Linux, macOS, or via Docker. Covers
  prerequisites, GPU driver requirements, installation steps, and verification.
keywords:
  - go-livepeer
  - install
  - orchestrator
...
<CardGroup cols={2}>
  ...
  <Card title="Transcoding quickstart" icon="rocket" href="/v2/orchestrators/setup/s-guide" arrow>
