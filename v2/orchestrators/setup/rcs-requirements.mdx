...
<Columns cols={2}>
  ...
  <Card title="Orchestrator stats & monitoring" icon="chart-line" href="./r-monitor" arrow />
  <Card title="Data centre setup" icon="server" href="../operations/r-hosting-models" arrow />
</Columns>
