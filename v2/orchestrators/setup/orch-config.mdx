...
- **-ethUrl** - Arbitrum RPC URL. See [Connect to Arbitrum](../setup/connect-to-arbitrum).
...
See [AI pipelines](../advanced/ai-pipelines) and [Developers BYOC](/v2/developers/ai-pipelines/byoc) for full AI setup.
