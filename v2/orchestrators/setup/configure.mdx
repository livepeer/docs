...
- Arbitrum wallet with ETH for gas. See <LinkArrow href="/v2/orchestrators/setup/connect" label="Connect to Arbitrum" newline={false} />.
...
<LinkArrow href="/v2/orchestrators/setup/connect" label="Connect to Arbitrum" newline={false} /> for how to set up a reliable RPC.
...
<LinkArrow href="/v2/orchestrators/guides/ai-and-job-workloads/diffusion-pipeline-setup" label="Batch AI Setup" newline={false} />.
...
<CardGroup cols={3}>
  <Card title="Connect to Arbitrum" icon="link" href="/v2/orchestrators/setup/connect" arrow horizontal>
    Set up the Arbitrum RPC endpoint and fund the wallet with ETH for gas.
  </Card>
  <Card title="Activate on the network" icon="circle-check" href="/v2/orchestrators/setup/connect" arrow horizontal>
    Register the Orchestrator on-chain and enter the Active Set via `livepeer_cli`.
  </Card>
  <Card title="CLI reference" icon="terminal" href="/v2/orchestrators/resources/reference/technical/cli-flags" arrow horizontal>
