...
description: >-
  Configure go-livepeer after installation: Arbitrum connection, pricing,
  service address, and optional transcoding or AI config.
keywords:
  - livepeer
  - orchestrators
  - configuration
...
After [installing go-livepeer](../setup/rs-install), configure the node so gateways can discover you and send work. This page covers core flags and optional config files.
...
See [AI pipelines](../operations/rc-ai-pipelines) and [Livepeer AI docs](https://docs.livepeer.org/ai/pipelines/overview) for full AI setup.
...
<Columns cols={2}>
  <Card title="Install go-livepeer" icon="download" href="../setup/rs-install" arrow />
  <Card title="Connect to Arbitrum" icon="plug" href="./connect-to-arbitrum" arrow />
  <Card title="CLI flags reference" icon="terminal" href="../resources/technical/cli-flags" arrow />
  <Card title="Rewards and fees" icon="coins" href="../operations/rs-rewards-and-fees" arrow />
</Columns>
