...
description: >-
  Add AI inference pipelines to an existing go-livepeer transcoding node —
  hardware check, aiModels.json configuration, and startup command update.
keywords:
  - livepeer
  - orchestrator
  - AI inference
...
- go-livepeer is installed and running as a transcoding orchestrator on Arbitrum mainnet (see [Install go-livepeer](/v2/orchestrators/setup/rs-install) and [Get Started](/v2/orchestrators/setup/s-guide)) {/* REVIEW: confirm target paths */}
...
- Model weights pre-downloaded for the pipeline(s) you want to serve (see [Download AI Models](/v2/orchestrators/operations/rc-ai-pipelines)) {/* REVIEW: confirm path */}
...
Check the [AI Pipelines](https://docs.livepeer.org/ai/pipelines/overview) documentation for any other pipeline-specific images.
...
For recommended pricing per pipeline, see [Job Types](/v2/orchestrators/concepts/rs-workloads). For a full multi-pipeline example, see [AI Pipeline Configuration](/v2/orchestrators/operations/rc-ai-pipelines). {/* REVIEW: confirm path */}
...
- [AI Pipeline Configuration](/v2/orchestrators/operations/rc-ai-pipelines) — advanced aiModels.json options, multi-GPU setup, external containers, and optimization flags {/* REVIEW: confirm path */}
