...
**Also useful:** [Protocol Economics](/v2/about/protocol/economics) and [Technical Architecture](/v2/about/network/technical-architecture).

**Primary CTA:** Get protocol context before integrating contracts.
<Card title="Protocol Overview" icon="scroll" href="/v2/about/protocol/overview" arrow>
