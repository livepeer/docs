...
node operations/scripts/validators/governance/audit-script-inventory.js --dry-run
node operations/scripts/validators/governance/audit-script-inventory.js --fix
node operations/scripts/validators/governance/audit-script-inventory.js --verbose

npm --prefix tools run repair:governance
node operations/scripts/orchestrators/repair-governance.js --dry-run
node operations/scripts/orchestrators/repair-governance.js --report-only
node operations/scripts/orchestrators/repair-governance.js --auto-commit
```
...
1. Create the script under a governed root such as `operations/scripts/`, `tests/`, `.githooks/`, or `tasks/scripts/`.
