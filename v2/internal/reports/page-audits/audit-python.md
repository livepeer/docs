...
### v2/gateways/payments/how-payments-work

- Missing import: /snippets/components/Callout.mdx
- Missing import: /snippets/components/Steps.mdx
...
### v2/gateways/payments/payment-clearinghouse
...
- `"https://github.com/shtukaresearch/livepeer-data-geography/tree/main/roles"` - file_not_found
  - Expected: `v2/internal/overview/"https:/github.com/shtukaresearch/livepeer-data-geography/tree/main/roles"`
...
- `/v2/gateways/references/contract-addresses` - file_not_found
  - Expected: `v2/pages/v2/gateways/references/contract-addresses`
...
### v2/orchestrators/orchestrator-journey

- `/v2/orchestrators/quickstart/join-a-pool` - file_not_found
  - Expected: `v2/pages/v2/orchestrators/quickstart/join-a-pool`
...
- `/v2/gateways/run-a-gateway/remote-signers` - file_not_found
  - Expected: `v2/pages/v2/gateways/run-a-gateway/remote-signers`
...
- `/v2/gateways/run-a-gateway/remote-signers` - file_not_found
  - Expected: `v2/pages/v2/gateways/run-a-gateway/remote-signers`
- `/v2/gateways/about-gateways/naap-platform` - file_not_found
  - Expected: `v2/pages/v2/gateways/about-gateways/naap-platform`
- `/v2/gateways/run-a-gateway/remote-signers` - file_not_found
  - Expected: `v2/pages/v2/gateways/run-a-gateway/remote-signers`
- `/v2/gateways/about-gateways/naap-platform` - file_not_found
  - Expected: `v2/pages/v2/gateways/about-gateways/naap-platform`
