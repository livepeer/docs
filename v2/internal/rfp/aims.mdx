...
<TabsContainer>
    ...
    <Tab title="Future-proofed" icon="space-station-moon-construction">
        ...
        - **[Scripts]** The docs-usefulness stack now centers on `tools/lib/docs-usefulness/scoring.js`, with `tests/unit/usefulness-rubric.test.js` validating rubric loading, rule coverage, route precedence, and score divergence behavior, and `tests/unit/usefulness-journey.test.js` validating journey completeness and configuration guardrails. This keeps human-versus-agent usefulness scoring and blocker detection in the active v2 toolchain without the removed legacy accuracy verifier.
