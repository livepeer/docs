...
<TabsContainer>
    <Tab title="AI-first" icon="user-robot">
        ...
        ## Constraints
        Full AEO (Answer Engine Optimisation) beyond semantic structure has not been explicitly audited. Structured data markup (JSON-LD) has not been verified across all pages.
    ...
    <Tab title="Future-proofed" icon="space-station-moon-construction">
        ...
        ### Interpretation of Future-proofed
    ...
    <Tab title="Stakeholder-focused" icon="people-group">
        ...
        ### Interpretation of Stakeholder-focused
