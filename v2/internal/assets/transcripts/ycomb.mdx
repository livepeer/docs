...
He joins YC's Brad Flora to talk about surviving six months of "pivot hell," why open-source analytics was the breakthrough, and how PostHog grew from fighting for its first users to launching full product lines-plus what he's learned about momentum, staying close to customers, and using transparency and humour to build a company that stands out.
...
In this conversation with Garry, she shares how great products (not marketing tricks) still win, why AI is unlocking a new kind of emotional relationship between consumers and technology, and what founders can learn from the messy creative stage we're in right now. She also breaks down how shifts in distribution, wellness, and digital behaviour are reshaping what it means to build for real human needs.
...
YC Visiting Group Partner Divya Bhat talks about how to set your KPIs (key metrics) and how to prioritise your time. This talk helps founders launch faster and set goals in order to make real progress.
...
Y Combinator is well-known for producing companies like Airbnb, Stripe, Coinbase and more. But what's the real story behind the success of YC and the companies they fund? This is everything you need to know about the programme.
...
What is a large language model? How can it be used to enhance your business? In this conversation, Ali Rowghani, Managing Director of YC Continuity, talks with Raza Habib, CEO of Humanloop, about the cutting-edge AI powering innovations today-and what the future may hold.  They discuss how large language models like Open AI's GPT-3 work, why fine-tuning is important for customising models to specific use cases, and the challenges involved with building apps using these models. If you're curious about the ethical implications of AI, Raza shares his predictions about the impact of this quickly developing technology on the industry and the world at large.
...
If you're looking to maximise your startup's potential, start by setting the right goals. Michael Seibel and Dalton Caldwell provide tips and strategies for setting goals that will help keep you and your new business focused on success-plus provide examples of bad goals to avoid.
Apply to Y Combinator: https://yc.link/DandM-apply
Work at a Startup: https://yc.link/DandM-jobs
...
One of the most common topics that founders ask us about is pricing and monetisation.  In this talk, YC Group Partner Aaron Epstein outlines 9 different business models, and highlights lessons from top YC companies on how to best monetise and price your product.
...
42:38 - Ronak Shah asks - What's your best pitch to high-performing startups in the Bay Area to adopt more of human centred design (something that the government has been moving towards surprisingly well, but that some fast moving startups have neglected resulting in controversy)
...
### #149 - Startup School Week 8 Recap - Adora Cheung on Prioritising Your Time and Kevin Hale on Evaluating Startup Ideas
...
First a lecture from Adora Cheung. Adora’s a partner at YC. Her lecture covers how to prioritise your time.
...
00:32 - Adora Cheung - How to Prioritise Your Time

2:12 - Real vs fake progress

4:10 - How to determine if you're prioritising the right tasks
...
11:52 - How do I know I'm prioritising my time well?
...
13:15 - Monetisation gives you the biggest bang for your buck
...
1:13 - Culture is behaviour and the right behaviours support a good business
...
9:36 - 3. List your values then model the behaviour
...
38:17 - Conversion rate optimisation
...
50:09 - Search Engine Optimisation
...
26:14 - Steve Adema asks - Russ Roberts has emphasised the limits of "only looking where the light is" when it comes to studying well-being. How
...
25:00 - Advice for employees who want to get a growth programme going
...
2:22 - How are their students differentiated from students educated in a traditional CS programme?

3:12 - Interacting with the parents of Make School students

8:12 - William Triska asks - What are some ways to encourage greater independence and autodidactic behaviour in students pursuing technical skills and knowledge?
...
43:06 - beep boop asks - What's your favourite robot?
...
Michael Babineau is cofounder and CEO of Second Measure. Second Measure analyzes billions of credit card transactions to answer real-time questions on consumer behaviour. They were in the Summer 2015 batch of YC and you can check them out at SecondMeasure.com.
...
5:05 - What are the macro trends in Meesho's favour in India?
...
35:36 - David Kofoed Wind asks - When Lambda School is incentivised to take in people that will land high paying jobs, how do you think about the diversity of candidates? One would imagine that it quickly becomes a game of pattern matching the stereotypical SV people.
...
56:43 - Serendipity and over optimising for it
...
21:32 - In retrospect, how would Ryan have advised himself around monetisation?
...
22:37 - What happens in the programme
...
32:57 - Track what are you trying to optimise
...
27:18 - The art, science, and labour of recruiting
...
Frank Lantz is a game designer and Director of the NYU Game Centre. He cofounded Area/Code Games and most recently released a game called Universal Paperclips in which you’re an AI that makes paperclips.
...
55:31 - Series A programme and leverage
...
10:07 - From The Beautiful Struggle // The Beautiful Game - You might argue that we’re already in a sort of failure mode, where our ability to assign dignity to arbitrary work and motivate people to work bullshit jobs is more efficient than our ability to allocate labour towards industry that would have greater social benefit, like education, healthcare, food, etc. If we’re already in this failure mode, it’s kind of the worst of all worlds, because not only are we assigning meaning to work that doesn’t need to be done, but, also, we could be redeploying that labour towards efforts that are actually important today.
...
32:02 - From The Emperor Has No Clothes, There is No Santa Claus, and Nothing is Rocket Science - I recognise that the meditative aspect of craft is an excellent way to cope with meaninglessness
...
1:25 - From The Days Are Long But The Decades Are Short - Minimise your own cognitive load from distracting things that don’t really matter.  It’s hard to overstate how important this is, and how bad most people are at it.
...
56:38 - Exonerations and social equity programmes
...
00:25 - Tuomas Grannas asks - What's your favourite LEGO theme?

1:25 - What is Front?

3:50 - Google Inbox shutting down

5:25 - Prioritising features
...
5:56 - Realising their first product didn’t work
...
27:38 - Some of Ryan’s favourite books
...
David Zeevi is a James S. McDonnell independent fellow at the Rockefeller University Centre for Studies in Physics and Biology. He focuses on developing computational methods for studying microbial ecology in the human gut and in the marine environment, and its contribution to human and environmental health.
...
11:55 - How was the study standardised across people?
...
15:00 - LC Carrier asks - How does YC feel about companies who don't want to raise VC after the programme?
...
40:00 - Ryan Carl Mercer asks - What's your preferred way organising your time?

41:05 - John Rigler asks - Can intrapreneurship be effective? I recently returned to IBM, have a patent, and yet have only vague ideas about how to signal and organise other like-minded folks. Could this path sabotage my dreams?
...
Elad Gil is an entrepreneur, operator, and investor. He cofounded Colour Genomics and Mixer Labs. Worked at Google and Twitter. And has invested in companies including Airbnb, Coinbase, and Stripe.
...
24:55 - Brianne Kimmel asks - What are some lessons learned in highly regulated sectors? When should you hire a General Counsel? How do you prioritise public policy and lobbying efforts?
...
38:41 - TD Bryant II asks - When your organisation is experiencing exponential growth, how do you choose which functions to outsource vs build/hire?

41:50 - Andrew Pikul asks - Who is your favourite Dragon Ball (Z/GT/Super) villain?
...
1:11:17 - Ryan Carl Mercer asks - Favourite MRE and thank you for your service sir.
...
This panel was hosted by Sharon Pope, Head of Marketing Programmes at YC.
...
Fermat’s Library is a platform for annotating papers. Each week they send out a paper annotated by their community. Some recent papers were Birds and Frogs by Freeman Dyson and Von Neumann's First Computer Programme by Donald Knuth.
...
Scott Aaronson is the David J. Bruton Centennial Professor of Computer Science at The University of Texas at Austin, and director of its Quantum Information Centre. Before teaching at UT, he taught Electrical Engineering and Computer Science at MIT. His research interests centre around the capabilities and limits of quantum computers, and computational complexity theory more generally.
...
Miles Brundage is an AI Policy Research Fellow with the Strategic AI Research Centre at the Future of Humanity Institute. He is also a PhD candidate in Human and Social Dimensions of Science and Technology at Arizona State University.
...
Ramon Recuero is an engineer at YC. He's the author of the Decentralised Future Series, which you can read here.
...
They surveyed 40,000 developers on things including their favourite frameworks, what they want in a job, and how they learned to code. You can read the report here.
...
Kevin Slavin is the Chief Science and Technology Officer of The Shed, which is an art centre in New York that’s opening in 2019.
