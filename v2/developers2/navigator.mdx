...
1. **Solutions Integrators**: Building end products like Daydream, Studio, Streamplace, Embody that integrate Livepeer's AI and video capabilities for specific use cases (e.g. live event production, interactive streaming, AI video editing).
2. **AI / Agent Developers**: Building custom AI or realtime workflows, AI models, or applications directly
3. **Video Developers**: Building streaming or transcoding applications.
4. **Application Developers**: Building applications - running their own gateway or using a public gateway - that call AI inference or video APIs, but not building on the protocol directly.
5. **Protocol Extenders??**: Building or improving the Livepeer protocol codebase (go-livepeer, ai-runner, comfystream, protocol contracts)
