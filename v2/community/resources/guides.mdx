...
<CardGroup cols={2}>
  ...
  <Card title="Live Pioneers resources" icon="users" href="https://livepioneers.app">
    Ecosystem recaps, Know Your Orchestrator interviews, and educational content in 8+ languages. The go-to resource for the delegator community.
  </Card>
</CardGroup>
