...
<CardGroup cols={2}>
  ...
  <Card title="Livepeer Foundation" icon="building" href="https://livepeer.foundation">
...
| **Orchestrator Payout Report** | Orchestrator payout data from Livepeer.Tools | [Livepeer.Tools](https://livepeer.tools) |
...
<CardGroup cols={2}>
  <Card title="Live Pioneers" icon="users" href="https://livepioneers.app">
...
For the full list of ecosystem applications — including Daydream, Streamplace, Embody, Frameworks SPE, Harmonic, and Agent SPE — see the [Platforms](/v2/platforms) section of the docs.
