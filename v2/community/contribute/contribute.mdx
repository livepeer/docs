...
<CardGroup cols={2}>
  ...
  <Card title="Run Infrastructure" icon="server" href="/v2/orchestrators/quickstart/guide">
    Operate an Orchestrator or Gateway node to provide video and AI compute capacity.
  </Card>
  <Card title="Stake LPT" icon="coins" href="/v2/delegators/delegation/delegate-your-lpt">
