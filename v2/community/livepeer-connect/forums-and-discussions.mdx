...
| Language channels | Moderated by [Live Pioneers](https://livepioneers.app) — see below |
...
[Live Pioneers](https://livepioneers.app) moderates Telegram groups for the Livepeer delegator community in **8+ languages**, making the protocol accessible to non-English-speaking participants globally.
...
Visit [livepioneers.app](https://livepioneers.app) to find your language group and connect with regional community members. Live Pioneers also produces weekly ecosystem recaps, Know Your Orchestrator interviews, and educational content in each supported language.
...
The Livepeer Foundation also posts updates via the Foundation account — check the [Foundation site](https://livepeer.foundation) for their social links.
...
Past community calls, governance discussions, protocol demos, and educational content are available on the [Livepeer YouTube channel](https://www.youtube.com/@LivepeerNetwork).

Live Pioneers also produces video content in multiple languages — find their channel via [livepioneers.app](https://livepioneers.app).
