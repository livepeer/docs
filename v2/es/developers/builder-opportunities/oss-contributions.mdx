...
- **Note:** The AI network is in its Beta phase. Report issues to the [Livepeer Discord](https://discord.gg/55SZFEEH5y).
...
<Tip>
  If you still have questions after reading a repo's contributing guide, open an issue or ask in the [Livepeer Discord](https://discord.gg/55SZFEEH5y). The team is generally responsive to genuine first-time contributor questions.
</Tip>
