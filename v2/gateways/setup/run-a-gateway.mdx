...
description: "Overview of steps to run a Livepeer Gateway node for video transcoding, AI inference, or both."
purpose: operations
pageType: guide
keywords:
  - livepeer
...
<Card
 ...
 Just want to get started?
    <GotoLink
      ...
      relativePath="./install/install-overview"
    />
</Card>
```text icon="terminal"
