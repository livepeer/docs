...
<Columns cols={2}>
    <Card
        title={<CustomCardTitle icon="cogs" title="Setup Options" />}
    ...
    <Card
        title={<CustomCardTitle icon="file-code" title="Gateway Tutorials" />}
    ...
    <Card
        title={<CustomCardTitle icon="hand-holding-dollar" title="Gateway Economics" />}
    ...
    <Card
        title={<CustomCardTitle icon="chart-line" title="AI Pipelines" />}
