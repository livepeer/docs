...
<Danger> (fixme) OpenAPI Spec is here: ai/worker/api/openapi.json </Danger>
 ...
 Live video endpoint has specialised handling for real-time streaming with MediaMTX integration
    </ResponseField>
...
- Specialised: Separate nodes for transcoding vs AI based on workload patterns
