...
Hosted services like [Daydream](../../developers/developer-platforms/daydream/daydream) operate as both application layers and Gateways.
...
Anyone that wants to build applications and services (like [Daydream](../../developers/developer-platforms/daydream/daydream) and [Stream.place](../../developers/developer-platforms/streamplace/streamplace)) on top of the Livepeer
