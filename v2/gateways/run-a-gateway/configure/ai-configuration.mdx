 ...
 **Do you think Livepeer should have a "testnet" available for Gateways to connect to?**
 ...
 Follow & contribute to the discussion in the [Discord](https://discord.gg/55SZFEEH5y) and on the [Forum](https://forum.livepeer.org)
...
<Tabs>
 ...
 Follow the instructions in the <DoubleIconLink label="AI Gateway Testing Guide" href="/gateways/run-a-gateway/test/test-gateway" iconLeft="link" /> to verify that the AI Gateway is operational.
        ...
        <Note>
 If binaries are unavailable for your system, you can build the [master branch](https://github.com/livepeer/go-livepeer/tree/master) of [go-livepeer](https://github.com/livepeer/go-livepeer) from source. Refer to the [Livepeer installation guide](/orchestrators/setting-up-an-orchestrator/install-go-livepeer#install-using-a-binary-release) or reach out to the Livepeer community on [Discord](https://discord.gg/55SZFEEH5y) for assistance.
        </Note>
    </Tab>
