...
<Tab title="Off-Chain Gateway" icon="floppy-disk">
  ...
  <Steps titleSize="h3">
    ...
    <Step title="Configure Gateway">
      ...
      Create the `docker-compose.yml` file that defines thesnippets/components/domain/04_GATEWAYS/callouts.jsx snippets/components/domain/04_GATEWAYS/quickstartTabs.jsx <Badge color="green">dual</Badge> gateway service.
