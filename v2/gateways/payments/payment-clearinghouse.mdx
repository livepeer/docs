...
<Note>
The underlying protocol for clearinghouses is implemented and in production use. No public clearinghouse service is operating at general availability as of early 2026; the managed access layer is still emerging.
</Note>
...
The Livepeer Foundation's planned managed access layer is expected to provide clearinghouse-adjacent capabilities including API key issuance and network observability. NaaP is targeting an MVP launch in 2026.
