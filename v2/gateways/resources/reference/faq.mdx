...
sidebarTitle: FAQ
description: >-
  Frequently asked questions for Livepeer gateway operators - the -broadcaster rename,
  ETH requirements, AI limitations, pricing, orchestrator discovery, and port
  configuration.
pageType: reference
audience: gateway
purpose: reference
