...
description: >-
  Official Livepeer protocol contract addresses on Arbitrum One and Ethereum Mainnet. Verified on-chain and
  automatically updated from the canonical governor-scripts source. The only official reference outside the blockchain.
...
'og:description': >-
  The only canonical source for Livepeer protocol contract addresses on Arbitrum One and Ethereum Mainnet. Verified
  on-chain, updated automatically.
'Twitter:card': summary_large_image
'twitter:title': Official Livepeer Contract Addresses
'twitter:description': Canonical reference for all Livepeer protocol smart contract addresses. Verified on-chain. Automatically updated.
---
