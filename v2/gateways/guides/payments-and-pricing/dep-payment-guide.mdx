...
description: >-
  Understand which payment model your Livepeer gateway needs. Covers on-chain ETH,
  remote signing, and clearinghouse options by gateway type, with a decision guide for
...
<Tip>
  For the current operator path map, see [Payment Paths](/v2/gateways/guides/payments-and-pricing/payment-guide).
</Tip>
...
<Tabs>
  <Tab title="Self-managed (on-chain)">
    **You hold the ETH. You manage the key. You sign the tickets.**
    ...
    Next step: [Fund Your Gateway](/v2/gateways/guides/payments-and-pricing/funding-guide)
  </Tab>
...
<CardGroup cols={2}>
  <Card title="Fund Your Gateway" icon="coins" href="/v2/gateways/guides/payments-and-pricing/funding-guide">
