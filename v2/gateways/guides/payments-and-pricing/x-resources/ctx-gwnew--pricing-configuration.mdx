...
description: >-
  Configure the maximum price your Livepeer gateway pays orchestrators per compute unit.
  Covers how price caps work and the flags for video and AI job pricing.
pageType: resource
audience: gateway
purpose: orient
status: current
