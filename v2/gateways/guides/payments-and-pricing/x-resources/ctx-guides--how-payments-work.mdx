...
description: >-
  Understand Livepeer's probabilistic micropayment system and what it means for gateway
  operators managing payment signing keys, ETH balances, and on-chain settlement.
pageType: resource
audience: gateway
purpose: orient
status: production
