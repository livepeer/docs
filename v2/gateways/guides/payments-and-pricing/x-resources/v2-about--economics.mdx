...
<div style={{ overflowX: 'auto', marginBottom: '24px' }}>
 ...
 How They Earn Money
    ...
    <tbody>
      <tr
        style={{ borderBottom: '1px solid #333', backgroundColor: "var(--lp-color-bg-card)" }}
      >
        <td
          style={{ padding: '10px 16px', color: "var(--lp-color-accent)", fontWeight: '500' }}
        >
 Orchestrator
        </td>
...
<div style={{ overflowX: 'auto' }}>
  ...
  >
    <thead>
      <tr style={{ backgroundColor: "var(--lp-color-accent)", color: 'white' }}>
        <th
          style={{
