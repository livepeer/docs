...
description: >-
  The business case for running a Livepeer gateway as an application developer - cost
  structures, revenue models, and what the off-chain AI gateway changes about the
  economics of building on Livepeer.
pageType: resource
audience: gateway
purpose: orient
status: current
