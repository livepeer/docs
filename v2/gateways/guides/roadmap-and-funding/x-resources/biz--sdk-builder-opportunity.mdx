...
description: >-
  Build Livepeer gateway clients in Python, browsers, mobile, or embedded systems using
  the remote signer architecture - without the Go binary or deep Ethereum integration.
PageType: resource
audience: gateway
purpose: orient
status: current
