...
description: >-
  The business case for using Livepeer as a replacement for cloud video transcoding -
  cost comparison with Mux, AWS MediaLive, and Wowza, and what the switch actually
  involves.
PageType: resource
audience: gateway
purpose: orient
...
The economics, what the switch involves, and where it fits well vs where it does not.
