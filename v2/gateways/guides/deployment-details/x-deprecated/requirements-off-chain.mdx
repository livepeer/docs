...
description: >-
  Requirements for running a Livepeer off-chain AI gateway on Linux. No ETH, LPT, or
  Arbitrum setup required - only a Linux machine and orchestrator addresses.
pageType: guide
audience: gateway
purpose: operate
status: deprecated
