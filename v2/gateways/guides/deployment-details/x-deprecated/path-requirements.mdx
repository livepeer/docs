...
description: >-
  Detailed prerequisites for each gateway setup path - what you need, what you do not
  need, and how to get started for AI off-chain, video on-chain, dual, and SDK-based
  gateways.
PageType: guide
audience: gateway
purpose: operate
...
<Tabs>
  ...
  <Tab title="Dual Gateway (AI + Video)" id="dual-ai-video" icon="circle-half-stroke">
    ...
    <Card title="Configure dual gateway" icon="gear" href="/v2/gateways/setup/configure" arrow horizontal>
...
<CardGroup cols={3}>
  ...
  <Card title="Configuration" icon="gear" href="/v2/gateways/setup/configure" arrow>
