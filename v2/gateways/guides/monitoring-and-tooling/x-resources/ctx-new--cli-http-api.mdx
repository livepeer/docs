...
<table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
 ...
 <th style={{ padding: '12px 16px', textAlign: 'left', fontWeight: '600', borderBottom: '2px solid #2d9a67' }}>URL</th>
  ...
  <tbody>
    <tr style={{ borderBottom: '1px solid #333', backgroundColor: "var(--lp-color-bg-card)" }}>
 <td style={{ padding: '10px 16px', color: "var(--lp-color-accent)", fontWeight: '500' }}>Gateway CLI API (default)</td>
 ...
 <td style={{ padding: '10px 16px', color: "var(--lp-color-accent)", fontWeight: '500' }}>Orchestrator CLI API</td>
