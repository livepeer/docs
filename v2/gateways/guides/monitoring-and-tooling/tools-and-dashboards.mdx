...
<Tabs>
    ...
    <Tab title="CLI Http API" icon="terminal">
        <BorderedBox variant="accent">
            ...
            Full API reference: <LinkArrow href="/v2/gateways/resources/reference/technical/api-reference/ai-worker-api" label="CLI HTTP API Reference" newline={false} />
        </BorderedBox>
    </Tab>
...
<CardGroup cols={3}>
  ...
  <Card title="API Reference" icon="code" href="/v2/gateways/resources/reference/technical/api-reference/ai-worker-api">
