...
<table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
  <thead>
    <tr style={{ backgroundColor: "var(--lp-color-accent)", color: "var(--lp-color-on-accent)" }}>
 ...
 <th style={{ padding: '12px 16px', textAlign: 'left', fontWeight: '600', borderBottom: '2px solid #2d9a67' }}>Description</th>
  ...
  <tbody>
    <tr style={{ backgroundColor: "var(--lp-color-bg-card)" }}>
 <td colSpan="3" style={{ padding: '10px 16px', fontWeight: '700', color: "var(--lp-color-accent)", borderBottom: '1px solid #333' }}>Network & Addresses</td>
    </tr>
 ...
 <td style={{ padding: '10px 16px' }}>External hostname where Gateway node is running</td>
    ...
    <tr style={{ backgroundColor: "var(--lp-color-bg-card)" }}>
 <td colSpan="3" style={{ padding: '10px 16px', fontWeight: '700', color: "var(--lp-color-accent)", borderBottom: '1px solid #333' }}>Node Type</td>
    </tr>
    <tr style={{ borderBottom: '1px solid #333' }}>
 ...
 <td style={{ padding: '10px 16px' }}>Time to wait for orchestrator info for manifest</td>
    ...
    <tr style={{ backgroundColor: "var(--lp-color-bg-card)" }}>
 <td colSpan="3" style={{ padding: '10px 16px', fontWeight: '700', color: "var(--lp-color-accent)", borderBottom: '1px solid #333' }}>Pricing & Payments</td>
    </tr>
    <tr style={{ borderBottom: '1px solid #333' }}>
 ...
 <td style={{ padding: '10px 16px' }}>JSON list of price per broadcaster</td>
    ...
    <tr style={{ backgroundColor: "var(--lp-color-bg-card)" }}>
 <td colSpan="3" style={{ padding: '10px 16px', fontWeight: '700', color: "var(--lp-color-accent)", borderBottom: '1px solid #333' }}>Blockchain / Ethereum</td>
    </tr>
    <tr style={{ borderBottom: '1px solid #333' }}>
 ...
 <td style={{ padding: '10px 16px' }}>Maximum gas price for ETH transactions in wei</td>
    ...
    <tr style={{ backgroundColor: "var(--lp-color-bg-card)" }}>
 <td colSpan="3" style={{ padding: '10px 16px', fontWeight: '700', color: "var(--lp-color-accent)", borderBottom: '1px solid #333' }}>Ticket System</td>
    </tr>
    <tr style={{ borderBottom: '1px solid #333' }}>
 ...
 <td style={{ padding: '10px 16px' }}>Deposit multiplier for max acceptable ticket faceValue</td>
    ...
    <tr style={{ backgroundColor: "var(--lp-color-bg-card)" }}>
 <td colSpan="3" style={{ padding: '10px 16px', fontWeight: '700', color: "var(--lp-color-accent)", borderBottom: '1px solid #333' }}>Services</td>
    </tr>
    <tr style={{ borderBottom: '1px solid #333' }}>
 ...
 <td style={{ padding: '10px 16px' }}>Maximum delay before initializing a round</td>
    ...
    <tr style={{ backgroundColor: "var(--lp-color-bg-card)" }}>
 <td colSpan="3" style={{ padding: '10px 16px', fontWeight: '700', color: "var(--lp-color-accent)", borderBottom: '1px solid #333' }}>Monitoring & Metrics</td>
    </tr>
    <tr style={{ borderBottom: '1px solid #333' }}>
 ...
 <td style={{ padding: '10px 16px' }}>Max time to wait for publishing metadata events</td>
    ...
    <tr style={{ backgroundColor: "var(--lp-color-bg-card)" }}>
 <td colSpan="3" style={{ padding: '10px 16px', fontWeight: '700', color: "var(--lp-color-accent)", borderBottom: '1px solid #333' }}>Storage</td>
    </tr>
    <tr style={{ borderBottom: '1px solid #333' }}>
