...
<BorderedBox variant="accent">
    ...
    <Tab title="Direct integration" icon="plug">
        ...
        - A clear API reference (the Gateway endpoint + the standard <LinkArrow href="/v2/gateways/resources/reference/technical/api-reference/ai-worker-api" label="AI API reference" newline={false} />)
