...
description: >-
  How Livepeer gateway payments work, what gateways cost to operate, and how operators
  earn at the business layer - covering both on-chain and off-chain gateway models.
PageType: guide
audience: gateway
purpose: explain
status: deprecated
...
How gateway payments work at the protocol level, what costs you control, and how the revenue side works.
...
<CardGroup cols={3}>
  ...
  <Card title="Pricing configuration" icon="sliders" href="/v2/gateways/guides/payments-and-pricing/pricing-configuration">
