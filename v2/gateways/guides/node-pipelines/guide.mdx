...
See <LinkArrow href="/v2/developers/build/ai-and-agents/model-support" label="Model Support" newline={false} /> for all supported batch AI pipeline types and model architectures.
...
<CardGroup cols={2}>
  <Card title="ComfyStream" icon="wand-magic-sparkles" href="/v2/developers/build/ai-and-agents/realtime-ai/comfystream/overview">
...
<CardGroup cols={2}>
  ...
  <Card title="Model Support" icon="microchip-ai" href="/v2/developers/build/ai-and-agents/model-support">
