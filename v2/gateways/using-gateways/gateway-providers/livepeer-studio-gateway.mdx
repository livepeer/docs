...
<Info>
  Livepeer Studio has its own full product documentation. This page covers Studio as a gateway provider in the context of the Livepeer network. For complete product guides, visit the [Livepeer Studio product section](/v2/platforms/livepeer-studio/overview) or [livepeer.studio](https://livepeer.studio).
</Info>
...
<CardGroup cols={2}>
  <Card title="Studio Product Docs" href="/v2/platforms/livepeer-studio/overview" icon="video-arrow-up-right" arrow>
