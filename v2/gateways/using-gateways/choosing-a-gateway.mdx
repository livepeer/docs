...
<StyledTable variant="bordered">
  ...
  <tbody>
    <TableRow>
      <TableCell>[**Livepeer Studio**](/v2/gateways/using-gateways/gateway-providers/livepeer-studio-gateway)</TableCell>
    ...
    <TableRow>
      <TableCell>[**Daydream**](/v2/gateways/using-gateways/gateway-providers/daydream-gateway)</TableCell>
    ...
    <TableRow>
      <TableCell>[**Cloud SPE**](/v2/gateways/using-gateways/gateway-providers/cloud-spe-gateway)</TableCell>
    ...
    <TableRow>
      <TableCell>[**Self-hosted**](/v2/gateways/run-a-gateway/run-a-gateway)</TableCell>
...
<CardGroup cols={2}>
  ...
  <Card title="Gateway Quickstart" href="/v2/gateways/quickstart/gateway-setup" icon="bolt-lightning" arrow>
