...
<<<<<<<< HEAD:v2/gateways/x-archived/_contextData_/new/gateways-new/setup/connect/lp-marketplace.mdx
import { ScrollableDiagram } from '/snippets/components/content/zoomableDiagram.jsx'
========
import { ScrollableDiagram } from '/snippets/components/displays/diagrams/ScrollableDiagram.jsx'
>>>>>>>> docs-v2-dev:v2/gateways/_workspace/archive/context-data/new/gateways-new/setup/connect/lp-marketplace.mdx
