...
description: >-
  System and account requirements for running a Livepeer gateway: video (on-chain), AI
  (off-chain), or dual. Covers OS, ETH, hardware, and orchestrator requirements per
  type.
PageType: guide
audience: gateway
purpose: operate
...
[//]: # (or separate flags. Rick to confirm.)
    ...
    [Dual Gateway Configuration →](/v2/gateways/setup/configure)
