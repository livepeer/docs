...
description: >-
  The business case for running a Livepeer Gateway - revenue models, use cases, and
  where gateway operators create and capture value in the Livepeer ecosystem.
PageType: guide
audience: gateway
purpose: operate
status: deprecated
