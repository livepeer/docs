...
23. **[Run a Video Gateway](https://docs.livepeer.org/gateways/setup/guide)** — Full on-chain video transcoding gateway setup: RTMP input, ETH key, Arbitrum RPC, orchestrator connection. Official.
