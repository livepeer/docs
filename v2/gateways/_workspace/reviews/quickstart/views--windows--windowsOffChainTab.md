# Review: Windows Off-Chain Gateway Quickstart TAB VIEW

**File:** `v2/gateways/quickstart/views/windows/windowsOffChainTab.mdx`
**Reviewed:** 2026-04-08
...
| 10. COMPLETENESS | 10.1 Coverage | FAIL | All 6 steps completely empty |

## Issues

1. **All steps empty:** Install, Configure, Run, Test, Monitor, Tips - zero content
2. **Frontmatter casing:** `PageType` should be `pageType`
3. **Missing frontmatter:** complexity, lifecycleStage
4. **Below 2KB minimum**
5. Users who select Windows off-chain see a blank guide
