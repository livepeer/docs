...
| **Video platform** | [Requirements](/v2/gateways/setup/prepare) | [Video config](/v2/Gateways/setup/configure) | [Troubleshooting](/v2/Gateways/guides/monitoring-and-tooling/troubleshooting) |
