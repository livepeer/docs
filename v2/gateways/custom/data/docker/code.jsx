...
-gateway -v 6`,
    description:
      'This starts a gateway in off-chain mode with verbose logging. The container will exit if no services are enabled, which confirms the binary runs correctly.',
  },
  testInstallOutput: {
