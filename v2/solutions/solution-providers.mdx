...
<CardGroup cols={2}>
    <Card title={<CustomCardTitle icon="comments" title="Developer Guide" />} href="../developers/" arrow>
     Learn how to build custom AI pielines and integrate your own models.
  </Card>
  <Card title={<CustomCardTitle icon="github" title="Gateway Applications" />} href="../gateways/" arrow>
