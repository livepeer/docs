...
description: >-
  How to integrate Streamplace into decentralised social apps, Web3 platforms,
...
how developers can integrate Streamplace into their decentralised applications. Streamplace provides a complete **ingest → provenance → transcoding → distribution** pipeline that plugs directly into the Livepeer Network.
...
This offloads all compute-heavy work to the **decentralised GPU market**.
