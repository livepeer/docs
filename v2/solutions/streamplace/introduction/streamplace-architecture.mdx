...
Streamplace sits between decentralised social applications and the Livepeer Network to provide a **full ingestion → provenance → transcoding → distribution** pipeline.
...
- provenance systems
- a node + SDK usable by any decentralised social app
...
## 3. **Application / Client Layer (Decentralised Social Apps)**
...
- enables trust-minimised delivery
