...
Streamplace transforms livestreams into **verifiable, rights-aware, decentralised video pipelines** that plug directly into the Livepeer Network.
...
Streamplace dispatches segments to the **Livepeer decentralised GPU network**:
