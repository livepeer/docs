...
<CardGroup cols={2}>
  <Card title={<CustomCardTitle icon="bolt-lightning" title="Quickstart" />} href="/v2/solutions/frameworks/overview" img="/snippets/assets/media/heros/solutions/frameworks/Frameworks_Hero_Quickstart.png">
