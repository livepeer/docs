...
- **Low or fluctuating ingest rate** - Check the broadcaster’s upload speed and encoder bitrate/keyframe settings. See [Stream via OBS](stream-via-OBS) and [Optimise latency](/v2/solutions/livepeer-studio/docs/livestream/optimize-latency).
