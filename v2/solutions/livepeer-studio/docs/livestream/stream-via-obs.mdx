...
<Info>
 Use **Keyframe Interval: 1** and disable **B-frames** (`bframes=0` in x264 options) for best compatibility with WebRTC playback. See [Optimise latency](/v2/solutions/livepeer-studio/docs/livestream/optimize-latency).
</Info>
...
See [Optimise latency](/v2/solutions/livepeer-studio/docs/livestream/optimize-latency) for full profiles.
