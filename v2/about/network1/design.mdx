...
The 2017 whitepaper specified a working system. The Network running today preserves the design intent and replaces several of the specific mechanisms with later, more practical equivalents. The differences matter to anyone reading the whitepaper as current spec.
...
<Card title={<CustomCardTitle icon="diagram-project" title="Network Architecture" />} href="/v2/about/network/architecture" horizontal arrow > The running fleet's three-layer topology in detail. </Card>
