...
<DynamicTableV2
  ...
  itemsList={[
    ...
    },
    {
      ...
      'What it is': 'Boolean. True once any Orchestrator has called `RoundsManager.initializeRound()` for this round. Reward calls and bond changes require initialisation.',
      Surface: 'Subgraph (`Round.initialized`)',
      'Where to read it': 'Explorer round status shows "Pending" until initialised',
    },
    {
...
<BorderedBox variant="accent">
  <Subtitle fontSize="1rem" marginBottom="0.5rem">**Subgraph (Arbitrum One)**</Subtitle>
  ...
  <Subtitle fontSize="1rem" marginTop="1rem" marginBottom="0.5rem">**Performance leaderboard (transcoding)**</Subtitle>
  ...
  <Subtitle fontSize="1rem" marginTop="1rem" marginBottom="0.5rem">**Performance leaderboard (AI)**</Subtitle>
  ...
  <Subtitle fontSize="1rem" marginTop="1rem" marginBottom="0.5rem">**Pricing**</Subtitle>

  All Orchestrators: `https://nyc.livepeer.com/orchestratorStats`

  <Subtitle fontSize="1rem" marginTop="1rem" marginBottom="0.5rem">**Explorer pages**</Subtitle>
  ...
  <Subtitle fontSize="1rem" marginTop="1rem" marginBottom="0.5rem">**On-chain (Arbitrum One)**</Subtitle>
