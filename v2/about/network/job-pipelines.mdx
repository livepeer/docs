...
<Card title={<CustomCardTitle icon="code-branch" title="Build a BYOC Pipeline" />} href="/v2/developers/build/compute/byoc/overview" horizontal arrow > How developers package and ship custom pipelines on the Network. </Card>
