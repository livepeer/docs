...
<Columns cols={2}>
  <Card title={<CustomCardTitle icon="cogs" title="Core Mechanisms" />} href="/v2/about/network/mechanisms" horizontal arrow>
  ...
  <Card title={<CustomCardTitle icon="store" title="Marketplace" />} href="/v2/about/network/marketplace-model" horizontal arrow>
