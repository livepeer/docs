...
Main Definition: The study of designing economic systems for decentralised networks.
...
A system that uses models to make decisions or interact with an environment-potentially running on decentralised GPUs.
