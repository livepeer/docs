...
{/* Stray duplicate frontmatter removed */}
...
Protocol Actors are the main participants in the protocol who make up the core functions of the protocol.
...
The process of moving tokens between chains (e.g. Ethereum Layer 1 and Arbitrum L2).
...
{/* Duplicate RTMP entry removed — see RTMP definition above */}
