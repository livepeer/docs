...
- **Treasury Creation**: [LIP-89](https://github.com/livepeer/LIPs/blob/main/LIPs/LIP-0089.md) and [LIP-92](https://github.com/livepeer/LIPs/blob/main/LIPs/LIP-0092.md) which established the [Treasury](/v2/delegators/guides/treasury/overview) and set the on-chain revenue allocation (sending 10% of new LPT emissions into the treasury).
...
**[On-Chain Treasury](/v2/delegators/guides/treasury/overview)**: A portion (10%) of token emissions flows to a community treasury (itself created by LIPs).
