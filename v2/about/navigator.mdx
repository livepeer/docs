...
<StyledSteps iconColor="var(--lp-color-accent)" titleColor="var(--accent)">
  <StyledStep title="Core Concepts" icon="lightbulb">
    **Build a mental model of what Livepeer is and how it works.**
    ...
    <LinkArrow href="/v2/about/concepts/composables/overview" label="Start with concepts" newline={false} />
  </StyledStep>
...
<Columns cols={2}>
 ...
 The role of the treasury in the Livepeer Protocol.
    ...
    <Card title="Protocol Economics" icon="coins" href="/v2/about/concepts/governance-and-economics" arrow>
...
<AccordionGroup>
  <Accordion title="I need the high-level picture first" icon="compass">
    ...
    <CardGroup cols={2}>
      <Card title="Livepeer Overview" icon="sparkles" href="/v2/about/concepts/composables/overview" arrow>
