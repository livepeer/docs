...
<DynamicTable
  ...
  itemsList={[
    ...
    { Template: "07_minor_page_issue.yml", "Use when": "Single minor reviewer finding on one page", "Required context": "exact page URL/path + one issue description" },
...
<Note>
Use `07_minor_page_issue.yml` for one low-risk page defect such as spelling, broken links, or minor formatting. Use `02_docs_page_issue.yml` when the fix needs broader editorial judgment, evidence, or acceptance criteria.
</Note>
